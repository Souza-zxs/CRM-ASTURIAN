import { ViewFilterOperand, ViewType, defineView } from 'zyra-sdk/define';
...
// object's existing view in place instead of deleting it (Zyra blocks deleting an object's only view).
