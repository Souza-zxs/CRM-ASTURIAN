...
const handler = async (
  ...
  return { synced: true, resendId, zyraId: event.recordId };
};
...
export default defineLogicFunction({
  ...
  description:
    'Creates a segment in Resend when a new resendSegment record is created in Zyra',
  timeoutSeconds: 30,
  handler,
