import { defineObject, FieldType, RelationType, OnDeleteAction, STANDARD_OBJECT_UNIVERSAL_IDENTIFIERS } from 'zyra-sdk/define';
...
export default defineObject({
  ...
  fields: [
    ...
    },
    {
      ...
      name: 'isZyra',
      label: 'Is Zyra',
      description: 'Whether the user is from Zyra',
      defaultValue: false,
      universalIdentifier:
        UNIVERSAL_IDENTIFIERS.objects.selfHostingUser.fields.isZyra
          .universalIdentifier,
    },
    {
      type: FieldType.TEXT,
