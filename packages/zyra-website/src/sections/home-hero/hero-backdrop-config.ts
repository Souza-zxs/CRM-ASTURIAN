...
// The authored artwork framing per viewport band. These thresholds are the
// artwork's own (how the scene crops against the copy), independent of
...
export const HERO_BACKDROP: Pick<
  ...
  'imageUrl' | 'settings'
> = {
  imageUrl: '/images/home/hero-lighthouse.webp',
  settings: {
    previewDistance: 3.2,
    imageFit: 'width',
    verticalAnchor: 0.5,
