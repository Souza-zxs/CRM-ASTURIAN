...
const TABLE_COLUMNS = [
  { id: 'company', isFirstColumn: true, label: 'Empresas', width: 180 },
  { id: 'type', isFirstColumn: false, label: 'Tipo', width: 132 },
  { id: 'url', isFirstColumn: false, label: 'Domínio', width: 150 },
];
...
const EXPANDED_TABLE_ROWS: ReadonlyArray<TableRow> = [
  ...BASE_TABLE_ROWS,
  {
    ...
    domain: 'zyra.com',
    isNew: true,
    logoSrc: sharedAssetUrls.companyLogoForDomain('zyra.com'),
    status: 'Cliente',
  },
  {
    company: 'Linear',
