        ...
        <PreviewSurface $active={active} ref={previewSurfaceRef}>
          <ToolbarRow>
            <ActionButton>
              ...
              <ActionLabel>Novo registro</ActionLabel>
            </ActionButton>
          ...
          <CommandPalette>
            <SearchRow>
              ...
              />
              <SearchPlaceholder>Digite qualquer coisa...</SearchPlaceholder>
              <SearchSparkles>
                <IconSparkles
                  color={SCENE.colors.mutedStrong}
                  size={14}
            ...
            <PaletteBody>
              ...
              >
                ...
                <MenuItemLabel>Exportar seleção como CSV</MenuItemLabel>
              </MenuItem>
              <MenuItem onClick={handleCommandClick}>
                <MenuIconBox>
                  <IconTrash
                ...
                <MenuItemLabel>Excluir 8 registros</MenuItemLabel>
              </MenuItem>

              <SectionLabel>Objeto &quot;Empresas&quot;</SectionLabel>
              <MenuItem onClick={handleCommandClick}>
                <MenuIconBox>
                  <IconDatabaseImport
                    size={MENU_ICON_SIZE}
                ...
                <MenuItemLabel>Importar dados</MenuItemLabel>
              </MenuItem>
              <MenuItem onClick={handleCommandClick}>
                <MenuIconBox>
                  <IconBuildingSkyscraper
                ...
                <MenuItemLabel>Criar empresa</MenuItemLabel>
              </MenuItem>
              ...
              <MenuItem onClick={handleCommandClick}>
                ...
                <MenuItemLabel>Ir para Pessoas</MenuItemLabel>
                <ShortcutHint>
              ...
              <MenuItem onClick={handleCommandClick}>
                ...
                <MenuItemLabel>Ir para Oportunidades</MenuItemLabel>
                <ShortcutHint>
                  <ShortcutKey>G</ShortcutKey>
                  depois
              ...
              <MenuItem onClick={handleCommandClick}>
                ...
                <MenuItemLabel>Ir para configurações</MenuItemLabel>
                <ShortcutHint>
                  <ShortcutKey>G</ShortcutKey>
                  depois
              ...
              <MenuItem onClick={handleCommandClick}>
                ...
                <MenuItemLabel>Ativar modo escuro</MenuItemLabel>
              </MenuItem>
              <SectionSpacer />
              <SectionSpacer />
            </PaletteBody>
