  ...
  return (
    <>
      ...
      <p>
        ...
        renew under the exact same conditions unless you cancel it or Horizon
        LTDA cancels it. You may cancel your Subscription renewal either through
        your online account management page or by contacting Horizon LTDA
        customer support team.
      </p>
      <p>
        A valid payment method, including credit card, is required to process
        the payment for your subscription. You shall provide Horizon LTDA with
        ...
        authorize Horizon LTDA to charge all Subscription fees incurred through
        your account to any such payment instruments.
      </p>
      <p>
        Should automatic billing fail to occur for any reason, Horizon LTDA will
      ...
      <h2>Free Trial</h2>
      <p>
        Horizon LTDA may, at its sole discretion, offer a Subscription with a
      ...
      <p>
        ...
        you will not be charged by Horizon LTDA until Free Trial has expired. On
        the last day of Free Trial period, unless you canceled your
      ...
      <p>
        At any time and without notice, Horizon LTDA reserves the right to (i)
      ...
      <h2>Fee changes</h2>
      <p>
        Horizon LTDA, in its sole discretion and at any time, may modify
      ...
      <p>
        Horizon LTDA will provide you with a reasonable prior notice of any
      ...
      <p>
        Horizon LTDA has the right but not the obligation to monitor and edit
      ...
      <p>
        ...
        Horizon LTDA and its licensors. Service is protected by copyright,
        ...
        the prior written consent of Horizon LTDA.
      </p>
      ...
      <p>
        ...
        are not owned or controlled by Horizon LTDA.
      </p>
      <p>
        Horizon LTDA has no control over, and assumes no responsibility for the
        content, privacy policies, or practices of any third party web sites or
        services. We do not warrant the offerings of any of these
        entities/individuals or their websites.
      </p>
      <p>
        YOU ACKNOWLEDGE AND AGREE THAT HORIZON LTDA SHALL NOT BE RESPONSIBLE OR
      ...
      <p>
        ...
        of the Federative Republic of Brazil, and the parties hereby submit to
        the exclusive jurisdiction of the courts of João Pessoa, Paraíba,
        Brazil, waiving any other jurisdiction, however privileged it may be.
      </p>
      <p>
