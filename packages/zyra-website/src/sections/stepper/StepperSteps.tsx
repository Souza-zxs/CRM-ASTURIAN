...
// The sticky element must be the direct grid item of the scroll stage: a
// grid item's sticky containing block is its own grid area, which the
// 300vh scroll track stretches tall — nesting this behind a plain wrapper
// div would shrink that containing block back down to the panel's own
// 100vh content height, and the panel would never stick.
