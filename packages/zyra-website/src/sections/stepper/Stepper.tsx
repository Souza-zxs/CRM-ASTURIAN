...
// The 300vh scroll track the sticky steps/visual ride — measured directly
// (rather than left to the steps column's own implicit height) so the
// scroll-progress rect always has real height to compute against.
      ...
      <ScrollTrack ref={scrollContainerRef}>
        <ScrollStage>
          ...
          <VisualColumn>
            <VisualMeasure>
              <StepperVisualFrame>
                <StepperVisual activeStepIndex={activeStepIndex} />
              </StepperVisualFrame>
            </VisualMeasure>
          </VisualColumn>
        </ScrollStage>
