...
import { WHY_ZYRA_HERO } from './why-zyra-visual-config';

// The /why-zyra hero: a textured backdrop with the halftone "20" floating
    ...
    <VisualFrame aria-hidden>
      <BackgroundLayer>
        <Image
          ...
          fill
          priority
          src="/images/why-zyra/hero/background.webp"
        />
      </BackgroundLayer>
      <ForegroundLayer>
        <HalftoneModel
          initialPose={WHY_ZYRA_HERO.initialPose}
          modelUrl={WHY_ZYRA_HERO.modelUrl}
          priority
          settings={WHY_ZYRA_HERO.settings}
        />
      </ForegroundLayer>
    </VisualFrame>
  );
