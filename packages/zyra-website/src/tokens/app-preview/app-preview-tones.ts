...
// straight from zyra-ui: TAG (tag color3/11), SIDEBAR (TintedIconTile
...
// Our tone names map 1:1 onto zyra-ui's tag colors, except `teal` is the
// product's `turquoise`.
...
// zyra-ui colors are `color(display-p3 r g b)` strings with 0–1 channels;
...
// The Ask-AI panel washes map onto zyra-ui's transparent ramp + primary
