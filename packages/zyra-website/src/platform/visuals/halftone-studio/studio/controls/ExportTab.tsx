...
const DEFAULT_IMAGE_FILE_NAME = 'zyra-logo.svg';
const DEFAULT_IMAGE_LABEL = 'Zyra image';
const REACT_EXPORT_SETTING_OPTIONS: Array<{
  ...
  },
  {
    ...
    description:
      'Wraps the mount node with a StyledVisualMount using @linaria/react and keeps the Zyra-ready mount shape.',
  },
  {
    key: 'includeUseClientDirective',
    label: "Add 'use client'",
    description:
      'Prepends the Next.js client directive so the exported component can be dropped into the Zyra website directly.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Exports both a named component and a default export to match the current Zyra illustration import pattern.',
  },
  {
    key: 'includeRegistryComment',
    label: 'Add Zyra header comment',
    description:
