...
import { lazy, type ReactNode, type RefObject } from 'react';
...
const CardHalftoneScene = lazy(() =>
  import('../halftone/CardHalftoneScene').then((module) => ({
    default: module.CardHalftoneScene,
  })),
);
