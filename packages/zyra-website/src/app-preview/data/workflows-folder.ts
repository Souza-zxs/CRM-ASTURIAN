  ...
  items: [
    {
      ...
      label: 'Criar empresa ao adicionar uma nova pessoa',
      icon: {
      ...
      page: {
        ...
        header: {
          ...
          title: 'Criar empresa ao adicionar uma nova pessoa',
        },
      },
    },
    {
      ...
      hidden: true,
      label: 'Enviar sequência de e-mails quando o negócio for engajado',
      icon: {
        color: APP_PREVIEW_TONES.workflowAvatarInk,
        kind: 'avatar',
        label: 'S',
      ...
      page: {
        ...
        header: {
          navbarActions: NAMED_WORKFLOW_NAVBAR_ACTIONS,
          title: 'Enviar sequência de e-mails quando o negócio for engajado',
        },
      },
    },
    {
