...
// old editor-data (30 files of authored zyra-sdk source fiction).
...
const rocketObjectSource = `import { defineObject, FieldType, RelationType } from 'zyra-sdk/define';
...
export default defineObject({
  ...
  fields: [
    ...
    },
    {
      ...
      // Customer object — we reuse what ships with Zyra).
...
const launchSiteObjectSource = `import { defineObject, FieldType, RelationType } from 'zyra-sdk/define';
...
const launchesViewSource = `import { defineView, ViewKey } from 'zyra-sdk/define';
...
const rocketsViewSource = `import { defineView, ViewKey } from 'zyra-sdk/define';
...
const payloadsViewSource = `import { defineView, ViewKey } from 'zyra-sdk/define';
...
const launchSitesViewSource = `import { defineView, ViewKey } from 'zyra-sdk/define';
...
const applicationConfigSource = `import { defineApplication } from 'zyra-sdk/define';
