...
describe('buildSignedPath', () => {
  ...
  it('should ignore absolute https urls', () => {
    expect(
      buildSignedPath({
        path: 'https://zyrahq.github.io/placeholder-images/workspaces/zyra-logo.png',
        token: 'tokenValue',
      }),
    ).toBe(
      'https://zyrahq.github.io/placeholder-images/workspaces/zyra-logo.png',
    );
  });
  ...
  it('should ignore absolute http urls', () => {
    expect(
      buildSignedPath({
        path: 'http://zyrahq.github.io/placeholder-images/workspaces/zyra-logo.png',
        token: 'tokenValue',
      }),
    ).toBe(
      'http://zyrahq.github.io/placeholder-images/workspaces/zyra-logo.png',
    );
  });
});
