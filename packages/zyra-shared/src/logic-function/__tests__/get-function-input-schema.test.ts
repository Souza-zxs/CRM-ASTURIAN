...
describe('getFunctionInputSchema', () => {
  ...
  it('should resolve ZyraRecord markers to record schemas', () => {
    const fileContent = `
        export const main = (params: {
          company: ZyraRecord<'company-universal-identifier'>;
          companies: ZyraRecord<'company-universal-identifier'>[];
          otherCompanies: Array<ZyraRecord<'company-universal-identifier'>>;
        }): void => {
          return;
        };
      `;
  ...
  it('should leave a bare ZyraRecord without a literal argument unresolved', () => {
    const fileContent = `
        export const main = (params: { record: ZyraRecord }): void => {
          return;
        };
      `;
    const result = getFunctionInputSchema(fileContent);
