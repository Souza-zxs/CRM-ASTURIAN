...
import { getFrontComponentBuildPlugins } from 'zyra-sdk/front-component-renderer/build';
...
const zyraUiIndividualIndex = path.resolve(
  dirname,
  '../../../zyra-ui/dist/individual/individual-entry.js',
);

const sdkDefineIndex = path.resolve(
  dirname,
  '../../../zyra-sdk/dist/define/index.mjs',
);

const sdkFrontComponentIndex = path.resolve(
  dirname,
  '../../../zyra-sdk/dist/front-component/index.mjs',
);

const zyraSharedIndividualDir = path.resolve(
  dirname,
  '../../../zyra-shared/dist/individual',
);

const ZYRA_SHARED_SUBMODULES = [
  'ai',
  'application',
  'constants',
  'database-events',
...
const zyraSharedAliases = Object.fromEntries(
  ZYRA_SHARED_SUBMODULES.map((submodule) => [
    `zyra-shared/${submodule}`,
    path.join(zyraSharedIndividualDir, submodule, 'index.js'),
  ]),
);
...
const storyAlias = {
  ...
  'zyra-sdk/define': sdkDefineIndex,
  'zyra-sdk/front-component': sdkFrontComponentIndex,
  'zyra-sdk/ui': zyraUiIndividualIndex,
  ...zyraSharedAliases,
};
