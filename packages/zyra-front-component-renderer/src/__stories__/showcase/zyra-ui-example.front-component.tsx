...
const ZyraUiComponent = () => {
  const [count, setCount] = useState(0);

  return (
    <ThemeProvider colorScheme="light">
      <div data-testid="zyra-ui-component" style={CARD_STYLE}>
        <H2Title
          title="Zyra UI"
...
export default defineFrontComponent({
  ...
  name: 'zyra-ui-component',
  description: 'A front component using Zyra UI remote components',
  component: ZyraUiComponent,
});
