...
const zyraUiTest: Story['play'] = async ({ canvasElement }) => {
  const canvas = within(canvasElement);

  await canvas.findByTestId('zyra-ui-component', {}, { timeout: 30000 });
...
export const ZyraUiReact: Story = createComponentStory('zyra-ui-example', {
  play: zyraUiTest,
});
export const ZyraUiPreact: Story = createComponentStory('zyra-ui-example', {
  runtime: 'preact',
  play: zyraUiTest,
});
