...
import { type CommandConfirmationModalResult } from 'zyra-sdk/front-component';
...
// Must match COMMAND_MENU_ITEM_CONFIRMATION_MODAL_RESULT_BROWSER_EVENT_NAME in asturian-front
