...
crossDocContracts.assertZyraMcpFormattingContract(fail);
...
if (failures.length > 0) {
  console.error('Zyra Codex plugin validation failed:');
...
console.log('Zyra Codex plugin validation passed.');
