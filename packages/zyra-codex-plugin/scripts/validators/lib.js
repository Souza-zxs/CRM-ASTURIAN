...
const PUBLIC_DOCS_MCP_SERVER_NAME = 'zyra-docs';
const PUBLIC_DOCS_MCP_URL = 'https://docs.zyra.com/mcp';
...
const isAllowedDocumentationHost = (hostname) => {
  ...
  return (
    ...
    host === 'example.zyra.com' ||
    host === 'myworkspace.zyra.com' ||
    host === 'myworkspace.customdomain.com' ||
    host === 'your-zyra-server.com' ||
    host === 'app.zyra.com' ||
    host === 'zyra.com' ||
    host === 'docs.zyra.com' ||
    host === 'www.docker.com' ||
