...
Use this reference for Zyra app objects, fields, relations, roles, and permissions.
...
- Prefer generated app entity patterns from `yarn zyra dev:add`.
...
- Avoid duplicating data that already exists on core Zyra objects.
...
```ts
import { defineObject, FieldType } from 'zyra-sdk/define';
