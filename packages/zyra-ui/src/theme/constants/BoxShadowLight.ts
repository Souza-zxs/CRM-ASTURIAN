...
export const BOX_SHADOW_LIGHT = {
  ...
  light: `0px 1px 3px 0px ${GRAY_SCALE_LIGHT_ALPHA.gray2}, 0px 4px 12px 0px ${GRAY_SCALE_LIGHT_ALPHA.gray2}`,
  strong: `0px 8px 24px 0px ${GRAY_SCALE_LIGHT_ALPHA.gray5}, 0px 2px 6px 0px ${GRAY_SCALE_LIGHT_ALPHA.gray2}`,
