  ...
  return (
    <BaseEmail width={333} locale={locale}>
      ...
      <MainText>
        ...
        <br />
        <Trans
          id="If you wish to continue using {productName}, please update your subscription within the next {remainingDays} {dayOrDays}."
          values={{ productName: brand.productName, remainingDays, dayOrDays }}
        />
      </MainText>
      <br />
      <CallToAction
        href={appUrl || `${brand.websiteUrl}settings/billing`}
