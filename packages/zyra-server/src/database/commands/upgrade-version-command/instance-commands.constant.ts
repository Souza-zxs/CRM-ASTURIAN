...
import { WhatsappChannelFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-16/2-16-instance-command-fast-1784207286077-whatsapp-channel';
import { AddInstagramChannelEntitiesFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-16/2-16-instance-command-fast-1784313148811-add-instagram-channel-entities';
...
export const INSTANCE_COMMANDS = [
  ...
  WhatsappChannelFastInstanceCommand,
  AddInstagramChannelEntitiesFastInstanceCommand,
