...
import { STANDARD_COMMAND_MENU_ITEMS } from 'src/engine/workspace-manager/zyra-standard-application/constants/standard-command-menu-item.constant';
...
export class AddLayoutCustomizationGuardToEditCommandsCommand extends ActiveOrSuspendedWorkspaceCommandRunner {
  ...
  override async runOnWorkspace({
    ...
    const { zyraStandardFlatApplication, workspaceCustomFlatApplication } =
