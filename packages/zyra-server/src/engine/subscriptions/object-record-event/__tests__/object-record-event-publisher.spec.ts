...
jest.mock(
  'src/engine/zyra-orm/utils/build-row-level-permission-record-filter.util',
  () => ({
...
jest.mock(
  'src/engine/zyra-orm/utils/is-record-matching-rls-row-level-permission-predicate.util',
  () => ({
...
} = require('src/engine/zyra-orm/utils/build-row-level-permission-record-filter.util');
const {
  isRecordMatchingRLSRowLevelPermissionPredicate,
} = require('src/engine/zyra-orm/utils/is-record-matching-rls-row-level-permission-predicate.util');
