...
import { ZyraORMException } from 'src/engine/zyra-orm/exceptions/zyra-orm.exception';
import { zyraORMGraphqlApiExceptionHandler } from 'src/engine/zyra-orm/utils/zyra-orm-graphql-api-exception-handler.util';
...
export const workspaceQueryRunnerGraphqlApiExceptionHandler = (
  ...
  switch (true) {
    ...
    case error instanceof ZyraORMException:
      return zyraORMGraphqlApiExceptionHandler(error);
