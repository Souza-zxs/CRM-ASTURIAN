...
describe('ClientConfigService', () => {
  ...
  let zyraConfigService: ZyraConfigService;
  ...
  beforeEach(async () => {
    ...
    zyraConfigService = module.get<ZyraConfigService>(ZyraConfigService);
  ...
  describe('getClientConfig', () => {
    beforeEach(() => {
      ...
      jest.spyOn(zyraConfigService, 'get').mockImplementation((key: string) => {
        const mockValues: Record<string, any> = {
          ...
          CALENDAR_BOOKING_PAGE_ID: 'team/zyra/talk-to-us',
          CLOUDFLARE_API_KEY: undefined,
          CLOUDFLARE_ZONE_ID: undefined,
          ALLOW_REQUESTS_TO_ZYRA_ICONS: false,
          ...
          ZYRA_LOGO_URL: 'https://app.zyra.com/logo.png',
    ...
    it('should return complete client config with all properties', async () => {
      ...
      expect(result).toEqual({
        ...
        isWhatsappMessagingEnabled: undefined,
        whatsappAppId: undefined,
        whatsappEmbeddedSignupConfigurationId: undefined,
        isInstagramMessagingEnabled: undefined,
        instagramAppId: undefined,
        instagramOauthRedirectUri: undefined,
        isVoiceAgentEnabled: undefined,
        isWhatsappAiAgentEnabled: undefined,
        isConfigVariablesInDbEnabled: false,
        isImapSmtpCaldavEnabled: false,
        isEmailingDomainInDemoMode: false,
        allowRequestsToZyraIcons: false,
        calendarBookingPageId: 'team/zyra/talk-to-us',
