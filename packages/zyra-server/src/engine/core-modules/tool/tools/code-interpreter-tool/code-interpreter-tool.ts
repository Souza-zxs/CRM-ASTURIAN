...
import { ZYRA_MCP_HELPER } from 'src/engine/core-modules/tool/tools/code-interpreter-tool/zyra-mcp-helper.const';
import {
...
export class CodeInterpreterTool implements Tool {
  ...
  async execute(
    ...
    try {
      ...
      const codeWithHelper = ZYRA_MCP_HELPER + '\n\n' + code;
      ...
      const result = await this.codeInterpreterService.execute(
        ...
        {
          env: {
            ZYRA_SERVER_URL: serverUrl,
            ZYRA_API_TOKEN: sessionToken,
          },
