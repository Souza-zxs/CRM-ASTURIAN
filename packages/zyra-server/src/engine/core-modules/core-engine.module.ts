...
import { InstagramCronsModule } from 'src/modules/instagram-crons/instagram-crons.module';
import { InstagramPublicReportModule } from 'src/modules/instagram-public-report/instagram-public-report.module';
...
import { VoiceAgentWebhooksModule } from 'src/modules/voice-agent/voice-agent-webhooks.module';
...
@Module({
  imports: [
    ...
    InstagramPublicReportModule,
    ConnectedAccountSyncWebhooksModule,
    VoiceAgentWebhooksModule,
    UsageModule,
    ClientConfigModule,
    FeatureFlagModule,
    FileModule,
    ...
    LoggerModule.forRootAsync({
      ...
      inject: [ZyraConfigService],
    }),
    MetricsModule,
    MessageQueueModule.registerAsync({
      useFactory: messageQueueModuleFactory,
      inject: [ZyraConfigService, RedisClientService, MetricsService],
    }),
    ExceptionHandlerModule.forRootAsync({
      useFactory: exceptionHandlerModuleFactory,
      inject: [ZyraConfigService, HttpAdapterHost],
    }),
    EmailModule.forRoot(),
