...
export class MicrosoftAPIsOauthRequestCodeGuard extends AuthGuard(
  ...
  async canActivate(context: ExecutionContext) {
    ...
    try {
      if (
        !this.zyraConfigService.get('MESSAGING_PROVIDER_MICROSOFT_ENABLED') &&
        !this.zyraConfigService.get('CALENDAR_PROVIDER_MICROSOFT_ENABLED')
      ) {
      ...
      new MicrosoftAPIsOauthRequestCodeStrategy(this.zyraConfigService);
