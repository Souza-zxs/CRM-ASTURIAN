...
describe('RefreshTokenService', () => {
  ...
  describe('verifyRefreshToken', () => {
    it('should verify a refresh token successfully', async () => {
      ...
      jest.spyOn(zyraConfigService, 'get').mockReturnValue('1h');
  ...
  describe('generateRefreshToken', () => {
    it('should generate a refresh token successfully', async () => {
      ...
      jest.spyOn(zyraConfigService, 'get').mockReturnValue(mockExpiresIn);
      jest
    ...
    it('should throw an error if expiration time is not set', async () => {
      jest.spyOn(zyraConfigService, 'get').mockReturnValue(undefined);
