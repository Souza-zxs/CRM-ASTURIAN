...
import ms from 'ms';
import { assertIsDefinedOrThrow } from 'zyra-shared/utils';
import { isWorkspaceActiveOrSuspended } from 'zyra-shared/workspace';
...
export class AccessTokenService {
  ...
  >): Promise<AuthToken> {
    const expiresIn = this.zyraConfigService.get('ACCESS_TOKEN_EXPIRES_IN');
