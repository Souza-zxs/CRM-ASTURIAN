...
import { parseJson } from 'zyra-shared/utils';
...
export class MicrosoftStrategy extends PassportStrategy(Strategy, 'microsoft') {
  constructor(zyraConfigService: ZyraConfigService) {
    super({
      clientID: zyraConfigService.get('AUTH_MICROSOFT_CLIENT_ID'),
      clientSecret: zyraConfigService.get('AUTH_MICROSOFT_CLIENT_SECRET'),
      callbackURL: zyraConfigService.get('AUTH_MICROSOFT_CALLBACK_URL'),
      tenant: 'common',
      scope: ['user.read'],
