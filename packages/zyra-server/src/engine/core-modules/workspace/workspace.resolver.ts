...
import { FeatureFlagKey, FileFolder } from 'zyra-shared/types';
...
export class WorkspaceResolver {
  ...
  async billingSubscriptions(
    ...
    if (!this.zyraConfigService.isBillingEnabled()) {
      return [];
    }
  ...
  isGoogleAuthEnabled(@Parent() workspace: WorkspaceEntity) {
    return (
      ...
      this.zyraConfigService.get('AUTH_GOOGLE_ENABLED')
    );
  }
  ...
  isMicrosoftAuthEnabled(@Parent() workspace: WorkspaceEntity) {
    return (
      ...
      this.zyraConfigService.get('AUTH_MICROSOFT_ENABLED')
    );
  }
  ...
  isPasswordAuthEnabled(@Parent() workspace: WorkspaceEntity) {
    return (
      ...
      this.zyraConfigService.get('AUTH_PASSWORD_ENABLED')
    );
  }
