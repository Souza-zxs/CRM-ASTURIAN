...
import { ConfigVariableGraphqlApiExceptionFilter } from 'src/engine/core-modules/zyra-config/filters/config-variable-graphql-api-exception.filter';
...
export class AdminPanelResolver {
  ...
  async getDatabaseConfigVariable(
    ...
    this.zyraConfigService.validateConfigVariableExists(key as string);
  ...
  async createDatabaseConfigVariable(
    ...
    await this.zyraConfigService.set(key, value);
  ...
  async updateDatabaseConfigVariable(
    ...
    await this.zyraConfigService.update(key, value);
  ...
  async deleteDatabaseConfigVariable(
    ...
    await this.zyraConfigService.delete(key);
  ...
  async addAiProvider(
    ...
    const customProviders = {
      ...this.zyraConfigService.get('AI_PROVIDERS'),
    };

    customProviders[providerName] = providerConfig;
    await this.zyraConfigService.set('AI_PROVIDERS', customProviders);
  ...
  async getAdminAiUsageByWorkspace(
    ...
    const useDollarMode = !this.zyraConfigService.get('IS_BILLING_ENABLED');
