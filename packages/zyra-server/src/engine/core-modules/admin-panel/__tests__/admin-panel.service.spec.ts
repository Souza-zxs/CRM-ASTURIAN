...
const ZyraConfigServiceGetAllMock = jest.fn();
const ZyraConfigServiceGetVariableWithMetadataMock = jest.fn();
const mockHttpClientGet = jest.fn();
const mockGetHttpClient = jest.fn().mockReturnValue({ get: mockHttpClientGet });

jest.mock(
  'src/engine/core-modules/zyra-config/constants/config-variables-group-metadata',
  () => ({
...
describe('AdminPanelConfigService', () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        AdminPanelConfigService,
        {
          ...
          useValue: {
            getAll: ZyraConfigServiceGetAllMock,
            getVariableWithMetadata:
              ZyraConfigServiceGetVariableWithMetadataMock,
          },
        },
      ],
    }).compile();
  ...
  describe('getConfigVariablesGrouped', () => {
    it('should correctly group and sort config variables', () => {
      ZyraConfigServiceGetAllMock.mockReturnValue({
        SERVER_URL: {
  ...
  describe('getConfigVariable', () => {
    it('should return config variable with all fields', () => {
      ZyraConfigServiceGetVariableWithMetadataMock.mockReturnValue({
        value: 'test-value',
        metadata: {
          group: 'SERVER_CONFIG',
    ...
    it('should throw error when variable not found', () => {
      ZyraConfigServiceGetVariableWithMetadataMock.mockReturnValue(undefined);
...
describe('AdminPanelVersionService', () => {
  ...
  describe('getVersionInfo', () => {
    ...
    beforeEach(() => {
      ...
      versionService['zyraConfigService'].get = mockEnvironmentGet;
    });
