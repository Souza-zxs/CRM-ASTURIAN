// Extensions where Zyra intentionally deviates from the IANA-standard mime
// mapping returned by mrmime. Zyra's storage layer persists these values
...
//                which predates TypeScript. `.tsx` is unregistered. Zyra uses
...
// mime AND (2) Zyra actually writes that extension via FileStorageService AND
...
export const ZYRA_MIME_POLICY: Record<string, string> = {
