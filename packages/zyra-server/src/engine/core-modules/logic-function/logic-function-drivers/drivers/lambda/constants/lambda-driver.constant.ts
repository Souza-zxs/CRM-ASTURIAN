...
export const COMMON_LAYER_NAME_PREFIX = 'zyra-common-layer';
export const YARN_INSTALL_FUNCTION_NAME_PREFIX = 'zyra-yarn-install';
export const BUILDER_FUNCTION_NAME_PREFIX = 'zyra-builder';

export const SDK_LAYER_PREFIX_IN_ZIP = 'nodejs/node_modules/zyra-client-sdk';

export const LAMBDA_PREBUILT_BUNDLE_CHECKSUM_TAG = 'zyra:bundle-checksum';
