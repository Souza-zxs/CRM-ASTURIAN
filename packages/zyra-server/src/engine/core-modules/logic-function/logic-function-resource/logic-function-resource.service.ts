...
`,
  ...
  // zyra-sdk is build-time only and zyra-client-sdk is injected at runtime
  // by Zyra (Lambda SDK layer / server-served modules), so neither needs to
  ...
  private async removeBuildTimeSdkFromDependencies(
    ...
    const packagesToRemove = ['zyra-sdk', 'zyra-client-sdk'];
