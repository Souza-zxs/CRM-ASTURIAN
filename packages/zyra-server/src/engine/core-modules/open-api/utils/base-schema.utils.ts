...
access to your workspace is the **Zyra MCP server**, not this OpenAPI schema.
...
\`\`\`bash
curl -H 'Authorization: Bearer <token>' \\
  ${serverUrl}/rest/open-api/${schemaName} > zyra-${schemaName}.json
\`\`\`
`,
      version: API_Version,
    },
    ...
    externalDocs: {
      description: 'Find out more about **Zyra**',
      url: 'https://zyra.com',
    },
