...
import { OBJECTS_WITH_CHANNEL_VISIBILITY_CONSTRAINTS } from 'zyra-shared/constants';
import {
  FieldMetadataType,
  FileFolder,
  ObjectRecord,
...
export class SearchService {
  ...
  private async buildIlikeFallbackQuery<Entity extends ObjectLiteral>({
    ...
    const timeoutMs = this.zyraConfigService.get(
  ...
  async getImageIdentifierValue(
    ...
    if (
      ...
      this.zyraConfigService.get('ALLOW_REQUESTS_TO_ZYRA_ICONS')
    ) {
