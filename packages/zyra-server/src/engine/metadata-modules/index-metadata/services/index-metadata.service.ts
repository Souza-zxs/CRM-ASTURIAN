...
import { compositeTypeDefinitions, RelationType } from 'zyra-shared/types';
...
import { MAX_CUSTOM_INDEXES_PER_OBJECT } from 'zyra-shared/constants';
  ...
  async deleteOne({
    ...
    if (!flatIndexToDelete.isCustom) {
      throw new IndexMetadataException(
        ...
        {
          userFriendlyMessage: msg`System indexes are required for Zyra to work and cannot be deleted.`,
        },
      );
    }
