import { isDefined, removePropertiesFromRecord } from 'zyra-shared/utils';
...
export const fromObjectMetadataEntityToFlatObjectMetadata = ({
  ...
  if (isDefined(objectMetadataEntity.labelIdentifierFieldMetadataId)) {
    ...
    // TODO uncomment once https://github.com/zyrahq/core-team-issues/issues/2172 has been resolved
