...
import { ViewVisibility } from 'zyra-shared/types';
import { isDefined, uncapitalize } from 'zyra-shared/utils';
  ...
  async getMinimalMetadata(
    ...
    const objectMetadataItems: MinimalObjectMetadataDTO[] = Object.values(
      ...
      .map((flatObjectMetadata) => {
        const isStandardApp = belongsToZyraStandardApp(flatObjectMetadata);
