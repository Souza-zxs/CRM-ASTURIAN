...
import type { ObjectRecordEvent } from 'zyra-shared/database-events';
...
export class CallWebhookJobsJob {
  ...
  async handle(
    ...
    // trigger in packages/zyra-zapier/src/triggers/trigger_record.ts
    // Also change the openApi schema for webhooks
    // packages/zyra-server/src/engine/core-modules/open-api/utils/computeWebhooks.utils.ts
