...
import {
  ...
  WIDGET_PROPS,
} from 'src/engine/workspace-manager/zyra-standard-application/constants/standard-page-layout-tabs.template';
import {
  type StandardPageLayoutConfig,
  type StandardPageLayoutTabConfig,
} from 'src/engine/workspace-manager/zyra-standard-application/utils/page-layout-config/standard-page-layout-config.type';
