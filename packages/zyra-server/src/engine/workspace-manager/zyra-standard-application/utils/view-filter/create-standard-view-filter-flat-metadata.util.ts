...
import { type ViewFilterOperand } from 'zyra-shared/types';
...
import { type AllStandardObjectViewFilterName } from 'src/engine/workspace-manager/zyra-standard-application/types/all-standard-object-view-filter-name.type';
