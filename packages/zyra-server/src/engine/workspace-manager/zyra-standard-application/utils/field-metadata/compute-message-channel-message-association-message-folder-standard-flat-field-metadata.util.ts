  ...
  > => ({
    ...
    position: createStandardFieldFlatMetadata({
      ...
      context: {
        ...
        description: i18nLabel(
          msg`Posição do registro da pasta de mensagens da associação de mensagens do canal de mensagens`,
        ),
        icon: 'IconHierarchy2',
        isSystem: true,
        isNullable: false,
    ...
    messageChannelMessageAssociation: createStandardRelationFieldFlatMetadata({
      ...
      context: {
        ...
        label: i18nLabel(msg`Associação de mensagens do canal de mensagens`),
        description: i18nLabel(msg`Associação de mensagens do canal de mensagens`),
        icon: 'IconMessage',
        isNullable: false,
        isUIEditable: false,
    ...
    messageFolderId: createStandardFieldFlatMetadata({
      ...
      context: {
        ...
        type: FieldMetadataType.UUID,
        label: i18nLabel(msg`Pasta de mensagens`),
        description: i18nLabel(msg`Pasta de mensagens`),
        icon: 'IconFolder',
        isNullable: false,
        isUIEditable: false,
      },
