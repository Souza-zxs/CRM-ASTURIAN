...
>): Record<AllStandardObjectFieldName<'taskTarget'>, FlatFieldMetadata> => ({
  ...
  position: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Posição do registro do alvo da tarefa`),
      icon: 'IconHierarchy2',
      isSystem: true,
      isNullable: false,
      defaultValue: 0,
  ...
  task: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      morphId: null,
      fieldName: 'task',
      label: i18nLabel(msg`Tarefa`),
      description: i18nLabel(msg`Tarefa do alvo da tarefa`),
      icon: 'IconCheckbox',
      isNullable: true,
      isUIEditable: false,
  ...
  targetPerson: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Alvo do alvo da tarefa`),
