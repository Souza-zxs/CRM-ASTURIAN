...
> => ({
  ...
  position: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Posição do registro da nota`),
      icon: 'IconHierarchy2',
      isSystem: true,
      isNullable: false,
      defaultValue: 0,
  ...
  title: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Título da nota`),
      icon: 'IconNotes',
      isNullable: true,
    },
    standardObjectMetadataRelatedEntityIds,
  ...
  bodyV2: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Corpo da nota`),
      icon: 'IconFilePencil',
      isNullable: true,
    },
    standardObjectMetadataRelatedEntityIds,
  ...
  noteTargets: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Alvos da nota`),
  ...
  attachments: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Anexos da nota`),
  ...
  timelineActivities: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Atividades da linha do tempo vinculadas à nota.`),
