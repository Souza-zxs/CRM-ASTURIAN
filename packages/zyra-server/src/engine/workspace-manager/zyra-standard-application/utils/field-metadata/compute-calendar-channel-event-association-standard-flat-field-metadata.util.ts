...
> => ({
  ...
  position: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(
        msg`Posição do registro de associação de evento do canal de calendário`,
      ),
      icon: 'IconHierarchy2',
      isSystem: true,
      isNullable: false,
  ...
  eventExternalId: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      label: i18nLabel(msg`ID externo do evento`),
      description: i18nLabel(msg`ID externo do evento`),
      icon: 'IconCalendar',
      isNullable: true,
      isUIEditable: false,
    },
  ...
  recurringEventExternalId: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      type: FieldMetadataType.TEXT,
      label: i18nLabel(msg`ID do evento recorrente`),
      description: i18nLabel(msg`ID do evento recorrente`),
      icon: 'IconHistory',
      isNullable: true,
      isUIEditable: false,
    },
  ...
  calendarChannelId: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      type: FieldMetadataType.UUID,
      label: i18nLabel(msg`ID do canal`),
      description: i18nLabel(msg`ID do canal`),
      icon: 'IconCalendar',
      isNullable: false,
      isUIEditable: false,
    },
