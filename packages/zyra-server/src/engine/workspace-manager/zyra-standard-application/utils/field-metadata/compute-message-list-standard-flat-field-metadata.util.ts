...
>): Record<AllStandardObjectFieldName<'messageList'>, FlatFieldMetadata> => ({
  ...
  position: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Posição do registro da lista`),
      icon: 'IconHierarchy2',
      isSystem: true,
      isNullable: false,
      defaultValue: 0,
  ...
  name: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`O nome da lista`),
      icon: 'IconUsersGroup',
      isNullable: true,
    },
    standardObjectMetadataRelatedEntityIds,
  ...
  members: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      morphId: null,
      fieldName: 'members',
      label: i18nLabel(msg`Membros`),
      description: i18nLabel(msg`Pessoas nesta lista`),
      icon: 'IconUser',
      isNullable: true,
  ...
  campaigns: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      morphId: null,
      fieldName: 'campaigns',
      label: i18nLabel(msg`Campanhas`),
      description: i18nLabel(msg`Campanhas enviadas para esta lista`),
      icon: 'IconSend',
      isUIEditable: false,
      isNullable: true,
  ...
  timelineActivities: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Eventos vinculados à lista`),
