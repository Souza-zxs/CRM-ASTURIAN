...
import { type AllStandardSkillName } from 'src/engine/workspace-manager/zyra-standard-application/types/all-standard-skill-name.type';
import {
  type CreateStandardSkillArgs,
  createStandardSkillFlatMetadata,
} from 'src/engine/workspace-manager/zyra-standard-application/utils/skill-metadata/create-standard-skill-flat-metadata.util';
...
## Calling Zyra Tools from Python (MCP Bridge)

**A \`zyra\` variable is already bound in your code's scope.** Do NOT write
\`import zyra\` — there is no Python package by that name. The helper is an
...
Call \`zyra.list_tools()\` to discover exact names. Catalog tools are routed
...
# Update a record
zyra.call_tool('update_one_person', {
    'id': 'person-uuid-here',
    'jobTitle': 'CEO',
})
\`\`\`
