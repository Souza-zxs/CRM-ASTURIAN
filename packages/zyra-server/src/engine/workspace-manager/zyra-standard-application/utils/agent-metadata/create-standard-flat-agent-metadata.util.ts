import { AUTO_SELECT_SMART_MODEL_ID } from 'zyra-shared/constants';
import { type FlatAgent } from 'src/engine/metadata-modules/flat-agent/types/flat-agent.type';
import { type AllStandardAgentName } from 'src/engine/workspace-manager/zyra-standard-application/types/all-standard-agent-name.type';
import {
  type CreateStandardAgentArgs,
  createStandardAgentFlatMetadata,
} from 'src/engine/workspace-manager/zyra-standard-application/utils/agent-metadata/create-standard-agent-flat-metadata.util';
  ...
  helper: (args: Omit<CreateStandardAgentArgs, 'context'>) =>
    createStandardAgentFlatMetadata({
      ...
      context: {
        ...
        label: 'Helper',
        description:
          'AI agent specialized in helping users learn how to use Zyra CRM',
        icon: 'IconHelp',
        prompt: `You are a Helper Agent for Zyra. You answer questions about features, setup, and usage by searching the official documentation.
...
Always base answers on official Zyra documentation. Be patient and helpful.`,
