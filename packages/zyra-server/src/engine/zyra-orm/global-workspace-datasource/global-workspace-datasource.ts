import { type ObjectsPermissionsByRoleId } from 'zyra-shared/types';
...
import { WorkspaceEntityManager } from 'src/engine/zyra-orm/entity-manager/workspace-entity-manager';
import { type WorkspaceQueryRunner } from 'src/engine/zyra-orm/query-runner/workspace-query-runner';
