import {
  ...
  RelationType as ZyraRelationType,
...
} from 'src/engine/zyra-orm/exceptions/relation.exception';
import {
  type EntitySchemaFieldMetadata,
  type EntitySchemaFieldMetadataMaps,
  type EntitySchemaObjectMetadataMaps,
} from 'src/engine/zyra-orm/global-workspace-datasource/types/entity-schema-metadata.type';
import { computeMorphOrRelationFieldJoinColumnName } from 'src/engine/metadata-modules/field-metadata/utils/compute-morph-or-relation-field-join-column-name.util';
import { converRelationTypeToTypeORMRelationType } from 'src/engine/zyra-orm/utils/convert-relation-type-to-typeorm-relation-type.util';
...
export function determineSchemaRelationDetails(
  ...
  const isManyToOne =
    fieldMetadata.settings.relationType === ZyraRelationType.MANY_TO_ONE;
