...
import { type UpgradeAwareRepositoryState } from 'src/engine/zyra-orm/upgrade-aware/upgrade-aware-repository-state';
import { UpgradeUnavailableEntityWriteException } from 'src/engine/zyra-orm/upgrade-aware/exceptions/upgrade-unavailable-entity-write.exception';
