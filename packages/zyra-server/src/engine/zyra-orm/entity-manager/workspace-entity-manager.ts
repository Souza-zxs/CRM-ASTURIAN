...
import { type DeepPartialWithNestedRelationFields } from 'src/engine/zyra-orm/entity-manager/types/deep-partial-entity-with-nested-relation-fields.type';
...
import { getEntityTarget } from 'src/engine/zyra-orm/entity-manager/utils/get-entity-target';
...
import { type GlobalWorkspaceDataSource } from 'src/engine/zyra-orm/global-workspace-datasource/global-workspace-datasource';
import {
  type OperationType,
  validateOperationIsPermittedOrThrow,
} from 'src/engine/zyra-orm/repository/permissions.utils';
...
import { getWorkspaceContext } from 'src/engine/zyra-orm/storage/orm-workspace-context.storage';
import { type RolePermissionConfig } from 'src/engine/zyra-orm/types/role-permission-config';
import { computePermissionIntersection } from 'src/engine/zyra-orm/utils/compute-permission-intersection.util';
