...
export enum ZyraORMExceptionCode {
...
const getZyraORMExceptionUserFriendlyMessage = (
  code: ZyraORMExceptionCode,
) => {
  switch (code) {
    case ZyraORMExceptionCode.METADATA_VERSION_MISMATCH:
      return msg`Data version mismatch. Please refresh and try again.`;
    case ZyraORMExceptionCode.WORKSPACE_SCHEMA_NOT_FOUND:
      return msg`Workspace schema not found.`;
    case ZyraORMExceptionCode.ROLES_PERMISSIONS_VERSION_NOT_FOUND:
      return msg`Roles and permissions configuration not found.`;
    case ZyraORMExceptionCode.FEATURE_FLAG_MAP_VERSION_NOT_FOUND:
      return msg`Feature configuration not found.`;
    case ZyraORMExceptionCode.USER_WORKSPACE_ROLE_MAP_VERSION_NOT_FOUND:
      return msg`User workspace role configuration not found.`;
    case ZyraORMExceptionCode.API_KEY_ROLE_MAP_VERSION_NOT_FOUND:
      return msg`API key role configuration not found.`;
    case ZyraORMExceptionCode.MALFORMED_METADATA:
      return msg`Data structure is invalid.`;
    case ZyraORMExceptionCode.WORKSPACE_NOT_FOUND:
    ...
    case ZyraORMExceptionCode.MISSING_MAIN_ALIAS_TARGET:
      return msg`Missing main alias target.`;
    case ZyraORMExceptionCode.METHOD_NOT_ALLOWED:
      return msg`This operation is not allowed.`;
    case ZyraORMExceptionCode.QUERY_READ_TIMEOUT:
    ...
    case ZyraORMExceptionCode.ENUM_TYPE_NAME_NOT_FOUND:
    case ZyraORMExceptionCode.ORM_EVENT_DATA_CORRUPTED:
      return STANDARD_ERROR_MESSAGE;
    case ZyraORMExceptionCode.NO_ROLE_FOUND_FOR_USER_WORKSPACE:
...
export class ZyraORMException extends CustomException<ZyraORMExceptionCode> {
  constructor(
    message: string,
    code: ZyraORMExceptionCode,
    ...
    super(message, code, {
      userFriendlyMessage:
        userFriendlyMessage ?? getZyraORMExceptionUserFriendlyMessage(code),
    });
  }
}
