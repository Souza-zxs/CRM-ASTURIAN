...
import { SendWhatsappTemplateActionModule } from 'src/modules/workflow/workflow-executor/workflow-actions/send-whatsapp-template/send-whatsapp-template-action.module';
...
@Module({
  imports: [
    ...
    SendWhatsappTemplateActionModule,
    MetricsModule,
  ],
