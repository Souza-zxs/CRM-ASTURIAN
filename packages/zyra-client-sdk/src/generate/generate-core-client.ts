...
import { DEFAULT_API_URL_NAME } from 'zyra-shared/application';
...
import zyraClientTemplateSource from './zyra-client-template.ts?raw';
...
export const generateCoreClientFromSchema = async ({
  ...
  const templateSource =
    clientWrapperTemplateSource ?? zyraClientTemplateSource;
...
// an installed zyra-client-sdk package (dist/core.mjs and dist/core.cjs).
