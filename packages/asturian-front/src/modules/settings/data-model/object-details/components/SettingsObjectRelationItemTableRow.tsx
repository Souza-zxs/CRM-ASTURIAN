...
import { FieldMetadataType, SettingsPath } from 'zyra-shared/types';
import { getSettingsPath, isDefined } from 'zyra-shared/utils';
import { IconChevronRight, useIcons } from 'zyra-ui/icon';
...
export const SettingsObjectRelationItemTableRow = ({
  ...
  // oxlint-disable-next-line zyra/no-navigate-prefer-link
