...
import { AvatarOrIcon, Chip, ChipVariant } from 'zyra-ui/data-display';
import {
  IconApi,
  IconCalendar,
  IconGmail,
...
const PROVIDERS_ICON_MAPPING = {
  EMAIL: {
    ...
    // App-managed, WhatsApp and Instagram connections aren't email accounts;
    // these cases are unreachable for the EMAIL source but the lookup type
    // still requires every provider.
    [ConnectedAccountProvider.APP]: IconMail,
    [ConnectedAccountProvider.WHATSAPP]: IconMail,
    [ConnectedAccountProvider.INSTAGRAM]: IconMail,
    default: IconMail,
  },
  CALENDAR: {
