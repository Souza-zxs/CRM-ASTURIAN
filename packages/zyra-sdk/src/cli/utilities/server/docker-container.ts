...
export const CONTAINER_NAME = 'zyra-app-dev';
export const TEST_CONTAINER_NAME = 'zyra-app-dev-test';
export const IMAGE = 'zyracrm/zyra-app-dev:latest';
...
export const getImageForVersion = (version = 'latest'): string => {
  ...
  return `zyracrm/zyra-app-dev:${tag}`;
};
