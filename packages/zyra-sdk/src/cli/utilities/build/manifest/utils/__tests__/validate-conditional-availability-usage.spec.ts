...
describe('validateConditionalAvailabilityUsage', () => {
  describe('valid usage', () => {
    it('should allow a variable inside a bare conditionalAvailabilityExpression', () => {
      const source = `
        import { defineCommandMenuItem } from 'zyra-sdk/define';
        import { objectMetadataItem } from 'zyra-sdk/define';
    ...
    it('should allow operators inside the expression', () => {
      const source = `
        import { defineCommandMenuItem } from 'zyra-sdk/define';
        import { objectPermissions, everyEquals } from 'zyra-sdk/define';
    ...
    it('should not flag same-named helpers imported from zyra-shared/utils', () => {
      const source = `
    ...
    it('should not flag Array.prototype.includes property access', () => {
      const source = `
        import { includes } from 'zyra-sdk/define';
        import { defineCommandMenuItem } from 'zyra-sdk/define';
    ...
    it('should trust files that define an expression (runtime placeholder is the backstop for in-file misuse)', () => {
      const source = `
        import { defineCommandMenuItem } from 'zyra-sdk/define';
        import { numberOfSelectedRecords } from 'zyra-sdk/define';
    ...
    it('should not flag a type-only import declaration', () => {
      const source = `
        import type { objectMetadataItem } from 'zyra-sdk/define';
  ...
  describe('invalid usage', () => {
    ...
    it('should flag an operator called at runtime', () => {
      const source = `
        import { isDefined } from 'zyra-sdk/define';
    ...
    it('should flag a variable imported from the zyra-sdk root entry', () => {
      const source = `
        import { objectMetadataItem } from 'zyra-sdk';
    ...
    it('should flag namespace-import runtime use with no expression', () => {
      const source = `
        import * as sdk from 'zyra-sdk/define';
