import { type ObjectFieldManifest } from 'zyra-shared/application';
import { COMPOSITE_FIELD_TYPE_SUB_FIELDS_NAMES } from 'zyra-shared/constants';
import {
  fieldMetadataDefaultValueFunctionName,
  type FieldMetadataDefaultValueFunctionNames,
  FieldMetadataType,
} from 'zyra-shared/types';
import { isDefined, isPlainObject } from 'zyra-shared/utils';
