...
// Records credit usage against the running application via the Zyra
// server's `/app/billing/charge` endpoint. Reads `ZYRA_API_URL` and
// `ZYRA_APP_ACCESS_TOKEN` from the execution env (injected by the
