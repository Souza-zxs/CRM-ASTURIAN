...
// stay in `zyra-sdk/define` — they are build-time metadata factories that
// the SDK CLI stubs out before bundling. Logic-function source files keep
// importing them from `zyra-sdk/define`, but should reach for *types* (and
// future runtime helpers) here, never directly from `zyra-shared/*`.
...
export type { RunAgentInput, RunAgentResult } from 'zyra-shared/application';
