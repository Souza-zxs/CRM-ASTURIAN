---
name: zyra-record-presentation
description: "Retrieve and present Zyra CRM records as readable summaries or tables, using the connected Zyra MCP server to discover fields, fetch relevant data, format dates and values, build record links, and avoid raw API output."
---

# Zyra Record Presentation
...
- If no Zyra MCP tools are available, say that no callable Zyra MCP server is available in the current thread and ask the user to connect or expose the intended workspace.
...
- For absolute links, combine the workspace origin with that path, for example `https://example.zyra.com/object/person/record-id`.
...
| :--- | :--- | ---: | :--- |
| [Acme renewal](https://example.zyra.com/object/opportunity/record-id-1) | Negotiation | EUR 12,450 | May 5, 2026, 11:43 AM |
| [Globex expansion](https://example.zyra.com/object/opportunity/record-id-2) | Discovery | EUR 8,000 | May 4, 2026, 4:10 PM |
```
