...
} from 'zyra-front-component-renderer';
import { AppPath, type EnqueueSnackbarParams } from 'zyra-shared/types';
...
import { assertUnreachable, isDefined } from 'zyra-shared/utils';
import { useIcons } from 'zyra-ui/icon';
...
export const useFrontComponentExecutionContext = ({
  ...
  const { t } = useLingui();
  // oxlint-disable-next-line zyra/no-state-useref
