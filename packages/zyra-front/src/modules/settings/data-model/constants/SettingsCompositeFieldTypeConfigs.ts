...
//TODO : isIncludedInUniqueConstraint refactor - https://github.com/zyrahq/core-team-issues/issues/1097
...
export const SETTINGS_COMPOSITE_FIELD_TYPE_CONFIGS = {
  ...
  [FieldMetadataType.EMAILS]: {
    ...
    exampleValues: [
      {
        primaryEmail: 'tim@zyra.com',
        additionalEmails: [
          'tim@zyra.com',
          'timapple@zyra.com',
          'johnappletim@zyra.com',
        ],
      },
      {
        primaryEmail: 'jane@zyra.com',
        additionalEmails: ['jane@zyra.com', 'jane.doe@zyra.com'],
      },
      {
        primaryEmail: 'john@zyra.com',
        additionalEmails: ['john.doe@zyra.com'],
      },
    ],
    category: 'Basic',
  ...
  [FieldMetadataType.LINKS]: {
    ...
    exampleValues: [
      {
        primaryLinkUrl: 'zyra.com',
        primaryLinkLabel: '',
        secondaryLinks: [{ url: 'zyra.com', label: 'Zyra' }],
      },
      {
        primaryLinkUrl: 'github.com/zyrahq/zyra',
        primaryLinkLabel: 'Zyra Repo',
        secondaryLinks: [{ url: 'zyra.com', label: '' }],
      },
      {
