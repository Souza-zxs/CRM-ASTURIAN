...
const SettingsAccountsInstagramCallback = lazy(() =>
  import('~/pages/settings/accounts/SettingsAccountsInstagramCallback').then(
    (module) => ({
      default: module.SettingsAccountsInstagramCallback,
    }),
  ),
);

const SettingsAccountsVoiceAgent = lazy(() =>
  import('~/pages/settings/accounts/SettingsAccountsVoiceAgent').then(
    (module) => ({
      default: module.SettingsAccountsVoiceAgent,
    }),
  ),
);

const SettingsAccountsWhatsappAgent = lazy(() =>
  import('~/pages/settings/accounts/SettingsAccountsWhatsappAgent').then(
    (module) => ({
      default: module.SettingsAccountsWhatsappAgent,
    }),
  ),
);
  ...
  <Suspense fallback={<SettingsSkeletonLoader />}>
    <Routes>
      ...
      >
        ...
        />
        <Route
          path={SettingsPath.AccountsInstagramCallback}
          element={<SettingsAccountsInstagramCallback />}
        />
        <Route
          path={SettingsPath.AccountsVoiceAgent}
          element={<SettingsAccountsVoiceAgent />}
        />
        <Route
          path={SettingsPath.AccountsWhatsappAgent}
