...
import { AppPath, ConnectedAccountProvider } from 'zyra-shared/types';
import { IconGoogle, IconMicrosoft } from 'zyra-ui/icon';
import { MainButton } from 'zyra-ui/input';
import { ClickToActionLink } from 'zyra-ui/navigation';
...
export const SyncEmails = () => {
  ...
  return (
    <ModalContent isVerticallyCentered isHorizontallyCentered>
      ...
      <SubTitle>
        {t`Sync your Emails and Calendar with ${productName}. Choose your privacy settings.`}
      </SubTitle>
