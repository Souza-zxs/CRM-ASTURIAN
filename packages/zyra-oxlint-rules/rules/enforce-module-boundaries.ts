...
const PACKAGE_TAG_MAP: Record<string, string[]> = {
  ...
  'zyra-emails': ['scope:backend'],
  'zyra-sdk': ['scope:sdk', 'scope:shared'],
  'zyra-zapier': ['scope:zapier'],
  'zyra-oxlint-rules': ['scope:shared'],
  'zyra-docs': ['scope:docs'],
  'zyra-e2e-testing': ['scope:testing'],
  'create-zyra-app': ['scope:create-app'],
};
