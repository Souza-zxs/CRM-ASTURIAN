---
title: Bring Product Data into Zyra
description: Sync product catalog data from a data warehouse into your CRM on a schedule.
---

Use this pattern to keep Zyra in sync with product data from your data warehouse (e.g., Snowflake, BigQuery, PostgreSQL).
...
5. **Upsert Record**: Create or update in Zyra
