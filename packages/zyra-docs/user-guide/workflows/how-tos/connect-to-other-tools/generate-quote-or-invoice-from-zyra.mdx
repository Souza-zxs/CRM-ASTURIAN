---
title: Generate a Quote or Invoice from Zyra
...
- [Generate a PDF from Zyra](/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-zyra) — attach generated PDFs to records
