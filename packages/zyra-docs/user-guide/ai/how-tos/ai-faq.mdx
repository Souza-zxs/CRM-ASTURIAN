---
title: AI FAQ
description: Frequently asked questions about AI features in Zyra.
---
...
<AccordionGroup>
  ...
  <Accordion title="What AI capabilities are planned?">
    ...
    1. **AI Chatbot**: A context-aware assistant that can access your Zyra data and help you with queries
  ...
  <Accordion title="Can I use my own AI models?">
    Initially, Zyra will use built-in AI models. Support for custom or external AI models may be added in future releases based on user feedback.
  </Accordion>
