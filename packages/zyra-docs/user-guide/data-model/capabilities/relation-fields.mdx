...
Many-to-many relations use a **junction object** pattern: an intermediate object that connects both sides. With the junction relation feature, Zyra displays the final linked records directly, hiding the intermediate object from the UI.
...
Zyra comes with pre-built relations between standard objects:
