...
Zyra's permission system allows you to control access to three main areas:
...
<Note>
Row-level permissions are a **Premium feature** available on the **Organization** plan.
</Note>
