...
Single Sign-On (SSO) allows your team members to log into Zyra using your organization's identity provider. This provides:
...
- Admin access to Zyra workspace
...
- Remove them from the Zyra workspace
...
- **Group mapping**: Map IdP groups to Zyra roles (if available)
- **Offboarding process**: Include Zyra in your deprovisioning workflow
