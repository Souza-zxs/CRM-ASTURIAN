...
Email sync takes time, especially for large mailboxes. Zyra imports emails at approximately **400 messages per minute** (limited by Gmail API rate limiting).
...
### 2. Contact Doesn't Exist in Zyra
