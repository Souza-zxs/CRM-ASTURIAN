...
Zyra supports **unlimited email accounts per user**. This is useful if you manage multiple inboxes, such as:
...
Emails from all your connected mailboxes are synced to Zyra and appear on:
