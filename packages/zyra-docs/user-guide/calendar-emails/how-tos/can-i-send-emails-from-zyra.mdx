---
title: Can I Send Emails from Zyra?
description: Information about sending emails directly from Zyra.
---

## Current Status

Zyra's email integration is designed to **sync and display** your email history. Emails cannot be composed or sent directly from Zyra's interface.
...
While you can't send emails manually from Zyra, you **can send emails automatically using Workflows**. This is useful for:
...
For email sequences and newsletters, we recommend using workflows to connect Zyra to a dedicated email marketing tool.
...
Native email composition from within Zyra is on our roadmap. Reach out to [contact@zyra.com](mailto:contact@zyra.com) to share your use case and help prioritize this feature.
