...
description: Control which emails are imported into Zyra.
---

## Overview

By default, Zyra syncs all external emails from your connected mailbox. You can limit what gets imported using **folder selection** and **visibility settings**.
