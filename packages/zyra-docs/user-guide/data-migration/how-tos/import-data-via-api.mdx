...
description: When and how to use Zyra's APIs for large-scale data imports.
---

## Overview

Zyra provides both **GraphQL** and **REST APIs** for programmatic data import. Use the API when CSV import isn't practical for your data volume or when you need automated, recurring imports.
...
Zyra enforces rate limits to ensure system stability:
...
- Verify formats match Zyra's requirements (see [Field Mapping](/user-guide/data-migration/capabilities/field-mapping))
...
- Verify data appears correctly in Zyra
...
Contact us at [contact@zyra.com](mailto:contact@zyra.com) or explore our [Implementation Services](/user-guide/getting-started/capabilities/implementation-services).
