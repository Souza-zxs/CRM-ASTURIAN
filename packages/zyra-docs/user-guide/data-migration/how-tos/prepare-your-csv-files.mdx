...
description: Complete step-by-step guide to format your data for import into Zyra.
---
...
**This is the most important step.** The sample file shows you the exact column names and format Zyra expects.
...
Zyra enforces uniqueness on certain fields. Duplicates will cause import errors.
...
3. Check for duplicates that already exist in Zyra
...
- Must be unique (no duplicates in file or in Zyra)
...
- Must be unique within your file and in Zyra
...
### ID Fields
- **Optional**: Zyra auto-generates IDs if not provided
...
- The parent record must already exist in Zyra
...
## Step 6: Ensure Fields Exist in Zyra
