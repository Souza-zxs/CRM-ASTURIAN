...
The command menu gives you **quick access to actions** in Zyra. You can access it in two ways:
...
- Create new views
- Access deleted records (Zyra supports soft and hard deletes)
