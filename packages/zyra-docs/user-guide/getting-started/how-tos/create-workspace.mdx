...
description: Follow a step-by-step guide on how to register on Zyra, choose a subscription plan, and set up your account.
---

import { VimeoEmbed } from '/snippets/vimeo-embed.mdx';

## Step 1: Registration
1. Navigate to [Zyra Sign Up](https://app.zyra.com).
...
## Support
For queries or help, connect with the dedicated support team at [contact@zyra.com](mailto:contact@zyra.com).
