...
- Predicates can reference objects and fields owned by your app or by Zyra's standard objects.
...
- See a working example in the `hello-world` sample app: `packages/zyra-apps/hello-world/src/roles/function-role.ts`.
