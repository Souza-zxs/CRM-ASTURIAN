...
```bash
npx nx run zyra-front:lint # pass --fix to fix lint errors
```
...
```bash
npx nx run zyra-front:test # run jest tests
npx nx run zyra-front:storybook:serve:dev # run storybook
npx nx run zyra-front:storybook:test # run tests # (needs yarn storybook:serve:dev to be running)
npx nx run zyra-front:storybook:coverage # (needs yarn storybook:serve:dev to be running)
```
