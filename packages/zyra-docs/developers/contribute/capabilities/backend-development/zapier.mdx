...
Effortlessly sync Zyra with 3000+ apps using [Zapier](https://zapier.com/). Automate tasks, boost productivity, and supercharge your customer relationships!
...
From the `packages/zyra-zapier` folder, run:
