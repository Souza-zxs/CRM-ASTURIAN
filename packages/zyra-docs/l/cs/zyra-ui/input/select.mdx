...
<Frame>
  <img src="/images/user-guide/what-is-zyra/20.png" alt="Hlavička" />
</Frame>
...
export const MyComponent = () => {
  ...
  return (
    <Select
      ...
      options={[
        { value: 'option1', label: 'Možnost A', Icon: IconZyraStar },
        { value: 'option2', label: 'Možnost B', Icon: IconZyraStar },
      ]}
      value="option1"
    />
  );
