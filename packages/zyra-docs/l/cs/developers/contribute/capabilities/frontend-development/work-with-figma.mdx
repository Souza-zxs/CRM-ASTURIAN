---
title: Práce s Figma
info: Zjistěte, jak můžete spolupracovat s Figmou Zyra
---
...
1. **Přístup ke sdílenému odkazu:** K Figma souboru projektu můžete přistoupit [zde](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/Zyra).
...
Na levém postranním panelu můžete přistupovat k různým stránkám Figmy společnosti Zyra. Takto jsou organizovány:
