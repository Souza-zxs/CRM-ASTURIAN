...
```bash
npx nx run asturian-front:lint # přidejte --fix pro opravu chyb ve formátování
```
...
```bash
npx nx run asturian-front:test # spusťte jest testy
npx nx run asturian-front:storybook:serve:dev # spusťte storybook
npx nx run asturian-front:storybook:test # spusťte testy # (vyžaduje, aby byl spuštěn yarn storybook:serve:dev)
npx nx run asturian-front:storybook:coverage # (vyžaduje, aby byl spuštěn yarn storybook:serve:dev)
```
