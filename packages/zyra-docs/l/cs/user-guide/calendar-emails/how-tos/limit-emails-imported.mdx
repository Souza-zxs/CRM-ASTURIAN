...
description: Ovládejte, které emaily se importují do Zyra.
---

## Přehled

Ve výchozím nastavení Zyra synchronizuje všechny externí emaily z vaší připojené poštovní schránky. Můžete omezit, co se importuje, pomocí **výběru složek** a **nastavení viditelnosti**.
