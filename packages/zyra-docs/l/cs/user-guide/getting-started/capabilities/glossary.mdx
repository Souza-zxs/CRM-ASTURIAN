---
title: Glosář
description: Seznamte se se základní terminologií používanou v aplikaci Zyra.
---

## API

API (rozhraní pro programování aplikací) umožňuje propojení Zyra s dalšími softwarovými systémy a vytváření vlastních integrací.
...
Příležitosti v Zyra CRM jsou potenciální obchody nebo prodeje s účty či kontakty.
...
Úkoly v Zyra CRM jsou přiřazené aktivity týkající se kontaktů, účtů nebo příležitostí.
...
Webhooky jsou automatizované zprávy odesílané z Zyra na jiné aplikace při výskytu specifických událostí, což umožňuje synchronizaci dat v reálném čase.
...
"Pracovní prostor" obvykle představuje společnost používající Zyra. Obsahuje všechny záznamy a data, která vy a členové vašeho týmu do Zyra přidáte.
...
Členové pracovního prostoru jsou uživatelé Zyra z vašeho týmu, kteří mají přístup k vašemu pracovnímu prostoru. Mohou být u záznamů přiřazeni jako vlastníci nebo přiřazené osoby.
