...
description: Sledujte podrobný návod, jak se zaregistrovat na Zyra, vybrat si plán předplatného a nastavit svůj účet.
---
...
1. Přejděte na [Registrace Zyra](https://app.zyra.com).
...
V případě dotazů nebo potřeby pomoci kontaktujte specializovaný tým podpory na [contact@zyra.com](mailto:contact@zyra.com) nebo pošlete zprávu na [Discord](https://discord.gg/cx5n4Jzs57).
