...
Jednotné přihlášení (SSO) umožňuje členům vašeho týmu přihlašovat se do Zyra pomocí poskytovatele identity vaší organizace. To přináší:
...
* Administrátorský přístup k pracovnímu prostoru Zyra

<Note>
**Pro uživatele vlastního hostování, kteří chtějí nastavit SSO**, obraťte se na contact@zyra.com
</Note>
...
* Odeberte je z pracovního prostoru Zyra
...
* **Mapování skupin**: Namapujte skupiny z IdP na role v Zyra (pokud je k dispozici)
* **Proces offboardingu**: Zahrňte Zyra do svého pracovního postupu deprovisioningu
