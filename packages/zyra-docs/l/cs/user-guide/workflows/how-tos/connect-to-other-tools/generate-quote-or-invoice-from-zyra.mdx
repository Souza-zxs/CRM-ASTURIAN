---
title: Vytvořte nabídku nebo fakturu z Zyra
...
* [Vygenerovat PDF z Zyra](/l/cs/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-zyra) — připojte vygenerované soubory PDF k záznamům
