---
title: Přeneste produktová data do Zyra
description: Synchronizujte data produktového katalogu z datového skladu do svého CRM podle plánu.
---

Použijte tento vzor k udržení synchronizace Zyra s produktovými daty z vašeho datového skladu (např. Snowflake, BigQuery, PostgreSQL).
...
5. **Upsert Record**: Vytvořte nebo aktualizujte záznam v Zyra
