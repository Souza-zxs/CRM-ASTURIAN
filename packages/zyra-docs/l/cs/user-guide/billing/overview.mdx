---
title: Fakturace
description: Seznamte se s cenami Zyra a spravujte své předplatné.
---

Zyra nabízí flexibilní cenové plány, které vyhoví potřebám vašeho týmu. Spravujte své předplatné, sledujte kredity pracovních postupů a přistupujte k fakturám — to vše v **Nastavení → Fakturace**.

## Co najdete v této sekci

<CardGroup cols={2}>
  <Card title="Cenové plány" icon="tags" href="/l/cs/user-guide/billing/capabilities/pricing-plans">
    Zjistěte více o cenových plánech Zyra a o tom, co je zahrnuto.
  </Card>
...
| **Organizace (vlastní hosting)** | Vše z Pro + funkce Premium (SSO, oprávnění na úrovni řádků), podpora týmu Zyra, není vyžadováno publikování vašeho vlastního kódu jako open-source před distribucí |
...
**Mohu používat Zyra zdarma?**
Ano! Hostujte Zyra sami a získejte všechny funkce Pro zdarma.
