...
description: Podrobný průvodce krok za krokem pro migraci vašich dat z libovolného CRM do Zyra.
---

## Přehled

Tento průvodce vás provede migrací vašich dat z libovolného CRM do Zyra. Proces zahrnuje audit vašich dat, přípravu vašeho pracovního prostoru Zyra, export z vašeho současného systému a import do Zyra.
...
Vytvořte mapovací dokument mezi vaším současným CRM a Zyra:
...
## Krok 3: Nastavte svůj pracovní prostor Zyra

Před importem dat připravte svůj pracovní prostor Zyra:
...
Pokud vaše data obsahují odkazy na uživatele (vlastník účtu, přiřazený uživatel apod.), tito uživatelé musí v Zyra existovat před importem. Jinak tyto relace nelze namapovat.
</Warning>
...
Otevřete každý exportovaný soubor CSV v tabulkovém editoru a připravte jej pro Zyra.

### Odstraňte duplicity

1. Seřaďte podle jedinečného pole (e-mail u lidí, doména u společností)
2. Odstraňte nebo sloučte duplicitní řádky
3. Ověřte, že v Zyra již neexistují žádné duplicity
...
Použijte `https://domain.com` (ne `domain.com` ani `www.domain.com`). To odpovídá formátu Zyra a předchází duplicitám, když připojíte synchronizaci e-mailu/kalendáře.
</Warning>
...
2. Použijte stejné e-mailové adresy, které uživatelé použili při připojení do vašeho pracovního prostoru Zyra
...
* Zyra začne synchronizovat e-maily k záznamům kontaktů
...
<AccordionGroup>
  <Accordion title="Mohu migrovat pracovní postupy automaticky?">
    V tuto chvíli ne. Pracovní postupy je nutné v Zyra znovu vytvořit ručně.
  </Accordion>
...
Kontaktujte [contact@zyra.com](mailto:contact@zyra.com) nebo si prohlédněte naše [Implementační služby](/l/cs/user-guide/getting-started/capabilities/implementation-services).
