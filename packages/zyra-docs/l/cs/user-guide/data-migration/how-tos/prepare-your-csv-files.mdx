...
description: Kompletní návod krok za krokem, jak naformátovat data pro import do Zyra.
---
...
**Toto je nejdůležitější krok.** Ukázkový soubor ukazuje přesné názvy sloupců a formát, který Zyra očekává.
...
Zyra vynucuje jedinečnost u některých polí. Duplicity způsobí chyby při importu.
...
3. Zkontrolujte duplicity, které už v Zyra existují
...
* Musí být jedinečné (žádné duplicity v souboru ani v Zyra)
...
* Musí být jedinečné v rámci vašeho souboru i v Zyra
...
* **Odkazy / Štítek odkazu**: `Zyra`
* **Odkazy / URL odkazu**: `https://zyra.com`
...
* **Volitelné**: Zyra automaticky generuje ID, pokud nejsou zadána
...
* Nadřazený záznam musí v Zyra již existovat
...
## Krok 6: Ujistěte se, že pole v Zyra existují
