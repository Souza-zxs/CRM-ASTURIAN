...
Po nahrání souboru a namapování sloupců Zyra vaše data ověří:

1. **Proběhne validace** — Zyra zkontroluje každý řádek na chyby
...
| --------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| Duplicitní hodnoty zvýrazněné žlutě                                   | Hodnota již existuje v Zyra nebo se ve vašem souboru vyskytuje dvakrát |
...
**Možnost 3: Nechte Zyra aktualizovat existující záznam**
...
3. Zyra aktualizuje existující záznam místo vytvoření duplicity
...
Pokud se shoduje alespoň jeden jedinečný identifikátor, Zyra záznam aktualizuje.
</Note>
...
3. Zkontrolujte, zda záznamy v Zyra již existují
...
To znamená, že v Zyra neexistuje společnost s tímto konkrétním identifikátorem.
...
Pokoušíte se propojit se záznamem, který v Zyra neexistuje.
...
Sloupec ve vašem souboru nelze namapovat, protože pole v Zyra neexistuje.
...
1. **Uživatel nepřijal pozvánku** — uživatel zatím v Zyra neexistuje
2. **Používáte uživatelské ID ze starého systému** — Zyra nedokáže spárovat ID z jiného systému
3. **Nesprávný formát e-mailu** — e-mail neodpovídá účtu uživatele v Zyra

### Jak to opravit

1. Ujistěte se, že všichni uživatelé **přijali svou pozvánku** do vašeho pracovního prostoru Zyra
2. Použijte **e-mailovou adresu** uživatele (ne jeho jméno nebo ID ze starého systému)
3. Použijte stejný e-mail, jaký použili k připojení do Zyra
...
<Check>Formát domény přesně odpovídá formátu Zyra</Check>
...
1. **Stáhněte si ukázkový soubor** — uvidíte přesný formát, který Zyra očekává
