...
Nadřazený („jedna“ strana) musí v Zyra existovat, než na něj budete moci odkazovat.
...
1. Exportujte nadřazené záznamy z Zyra
...
Použijte `https://domain.com` (ne pouze `domain.com`). To odpovídá způsobu, jak Zyra ukládá domény společností, a předchází chybám při párování.
</Warning>
...
Zyra automaticky propojí každý podřízený záznam s odpovídajícím nadřazeným.
...
| **Neexistující záznamy**     | Nadřazený záznam v Zyra neexistuje            | Nejprve importujte nadřazené záznamy nebo zkontrolujte překlepy |
| **Rozdílná velikost písmen** | `Acme.com` v souboru, ale v Zyra `acme.com`   | Zajistěte přesnou shodu velikosti písmen                        |
...
<AccordionGroup>
  <Accordion title="Co když můj nadřazený záznam nemá doménu ani e-mail?">
    Máte dvě možnosti:
    1. Použijte Zyra `id` (exportujte nadřazené záznamy, abyste získali jejich ID)
