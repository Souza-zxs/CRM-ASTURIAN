...
Zyra obsahuje standardní objekty:
...
Každý podnik funguje jinak. Přizpůsobením datového modelu můžete přetvořit Zyra podle **svých** procesů namísto toho, abyste své procesy nutili do rigidního systému.

Zyra nabízí plnou flexibilitu:
...
Identifikujte hlavní pojmy, se kterými pracujete. Zyra již poskytuje:
