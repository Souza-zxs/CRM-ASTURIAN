---
title: 始めに
description: Zyra 開発者ドキュメントへようこそ。Zyra の拡張、セルフホスティング、貢献のためのリソースです。
---

import { CardTitle } from "/snippets/card-title.mdx"

<CardGroup cols={2}>
  <Card href="/l/ja/developers/extend/api" icon="code">
