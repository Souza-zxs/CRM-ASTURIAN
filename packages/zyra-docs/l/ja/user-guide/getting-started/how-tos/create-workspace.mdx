---
title: ワークスペースを作成する
description: Zyra に登録し、サブスクリプションプランを選択して、アカウントを設定するためのステップバイステップガイドに従ってください。
---
...
1. [Zyraへのサインアップ](https://app.zyra.com)に移動します。
...
ご質問やサポートが必要な場合は、[contact@zyra.com](mailto:contact@zyra.com) または [Discord](https://discord.gg/cx5n4Jzs57) で専属のサポートチームに連絡してください。
