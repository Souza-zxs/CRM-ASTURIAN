---
title: Zyra を知る
description: Zyra ユーザーガイドへようこそ。高度な設定やベストプラクティスのためのリソースです。
---

import { CardTitle } from "/snippets/card-title.mdx"

<CardGroup cols={3}>
  <Card href="/l/ja/user-guide/getting-started/capabilities/what-is-zyra" img="/images/user-guide/api/api.png">
    <CardTitle>Zyra を知る</CardTitle>
    Zyra とは何か、ビジネスにどのように役立つかを学びましょう。
  </Card>
