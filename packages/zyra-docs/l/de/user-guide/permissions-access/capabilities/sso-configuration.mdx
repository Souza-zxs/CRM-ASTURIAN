...
Single Sign-On (SSO) ermöglicht es Ihren Teammitgliedern, sich mit dem Identitätsanbieter Ihrer Organisation bei Zyra anzumelden. Dies bietet:
...
* Administratorzugriff auf den Zyra-Arbeitsbereich

<Note>
**Für Self-Hosting-Nutzer, die SSO einrichten möchten**, wenden Sie sich an contact@zyra.com
</Note>
...
* Entfernen Sie sie aus dem Zyra-Arbeitsbereich
...
* **Gruppenzuordnung**: Ordnen Sie IdP-Gruppen Zyra-Rollen zu (falls verfügbar)
* **Offboarding-Prozess**: Beziehen Sie Zyra in Ihren Deprovisioning-Workflow ein
