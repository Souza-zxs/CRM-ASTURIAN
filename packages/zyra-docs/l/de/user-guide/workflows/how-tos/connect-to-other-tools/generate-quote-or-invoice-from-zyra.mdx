---
title: Ein Angebot oder eine Rechnung aus Zyra erstellen.
...
* [Ein PDF aus Zyra generieren](/l/de/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-zyra) — generierte PDFs an Datensätze anhängen
