...
2. **Daten in und aus Zyra bringen**: Verbinden Sie Zyra über API-Aufrufe und Webhooks mit Ihrer Datenbank und anderen Werkzeugen.
...
* **Formular**: Eingaben von Benutzern innerhalb der Zyra-Oberfläche zum Zeitpunkt der Ausführung abfragen
