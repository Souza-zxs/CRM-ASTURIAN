...
description: Erfahren Sie mehr über die in Zyra-Workflows verfügbaren Aktionen.
---
...
<Note>
You can only send emails from mailboxes synced to your own Zyra account. Sending from other team members' mailboxes (e.g., the account owner's email) is on the roadmap.
</Note>
