...
description: Schritt-für-Schritt-Anleitung zur Migration Ihrer Daten von jedem CRM zu Zyra.
---

## Übersicht

Diese Anleitung führt Sie durch die Migration Ihrer Daten von jedem CRM zu Zyra. Der Prozess umfasst die Überprüfung Ihrer Daten, die Vorbereitung Ihres Zyra-Arbeitsbereichs, den Export aus Ihrem aktuellen System und den Import in Zyra.
...
Erstellen Sie ein Zuordnungsdokument zwischen Ihrem aktuellen CRM und Zyra:
...
## Schritt 3: Richten Sie Ihren Zyra-Arbeitsbereich ein

Bereiten Sie Ihren Zyra-Arbeitsbereich vor, bevor Sie Daten importieren:
...
Wenn Ihre Daten Benutzerreferenzen enthalten (Account Owner, Assignee usw.), müssen diese Benutzer vor dem Import in Zyra existieren. Andernfalls können diese Beziehungen nicht zugeordnet werden.
</Warning>
...
Öffnen Sie jede exportierte CSV in einer Tabellenkalkulationsanwendung und bereiten Sie sie für Zyra vor.
...
3. Überprüfen Sie, dass in Zyra keine Duplikate vorhanden sind
...
Verwenden Sie `https://domain.com` (nicht `domain.com` oder `www.domain.com`). Dies entspricht dem Format von Zyra und verhindert Duplikate, wenn Sie die E-Mail-/Kalendersynchronisierung verbinden.
</Warning>
...
2. Verwenden Sie dieselben E-Mail-Adressen, mit denen die Benutzer Ihrem Zyra-Arbeitsbereich beigetreten sind
...
1. Navigieren Sie zum Objekt in Zyra
...
* Zyra beginnt, E-Mails mit Kontaktdatensätzen zu synchronisieren
...
<AccordionGroup>
  <Accordion title="Kann ich Workflows automatisch migrieren?">
    Derzeit nicht. Workflows müssen in Zyra manuell neu erstellt werden.
  </Accordion>
...
Kontaktieren Sie [contact@zyra.com](mailto:contact@zyra.com) oder informieren Sie sich über unsere [Implementierungsservices](/l/de/user-guide/getting-started/capabilities/implementation-services).
