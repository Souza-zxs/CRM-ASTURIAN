...
description: Vollständige Schritt-für-Schritt-Anleitung zum Formatieren deiner Daten für den Import in Zyra.
---
...
**Dies ist der wichtigste Schritt.** Die Beispieldatei zeigt dir die exakten Spaltennamen und das Format, das Zyra erwartet.
...
Zyra erzwingt die Eindeutigkeit bestimmter Felder. Duplikate führen zu Importfehlern.
...
3. Prüfe auf Duplikate, die in Zyra bereits existieren
...
* Muss eindeutig sein (keine Duplikate in der Datei oder in Zyra)
...
* Muss innerhalb deiner Datei und in Zyra eindeutig sein
...
* **Links / Link-Label**: `Zyra`
* **Links / Link-URL**: `https://zyra.com`

Für sekundäre Links verwenden Sie die Spalte **Links / Sekundäre Links**:

```
[{"url":"https://zyra.com","label":"Zyra"}]
```
...
* **Optional**: Zyra erstellt IDs automatisch, wenn sie nicht angegeben werden
...
* Der übergeordnete Datensatz muss bereits in Zyra vorhanden sein
...
## Schritt 6: Sicherstellen, dass Felder in Zyra vorhanden sind
