...
description: Wann und wie Sie die APIs von Zyra für groß angelegte Datenimporte verwenden.
---

## Übersicht

Zyra stellt sowohl **GraphQL**- als auch **REST-APIs** für den programmatischen Datenimport bereit. Verwenden Sie die API, wenn der CSV-Import für Ihr Datenvolumen nicht praktikabel ist oder wenn Sie automatisierte, wiederkehrende Importe benötigen.
...
Zyra setzt Rate-Limits durch, um die Systemstabilität zu gewährleisten:
...
Zyra unterstützt zwei API-Typen:
...
* Überprüfen Sie, ob die Formate den Anforderungen von Zyra entsprechen (siehe [Feldzuordnung](/l/de/user-guide/data-migration/capabilities/field-mapping))
...
* Überprüfen Sie, ob die Daten in Zyra korrekt angezeigt werden
...
Kontaktieren Sie uns unter [contact@zyra.com](mailto:contact@zyra.com) oder informieren Sie sich über unsere [Implementierungsservices](/l/de/user-guide/getting-started/capabilities/implementation-services).
