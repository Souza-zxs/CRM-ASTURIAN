...
2. Startet eine isolierte Zyra-Testinstanz mithilfe der Composite-Action `./.github/actions/spawn-zyra-app-dev-test` (das CI-Äquivalent zu `yarn zyra server start --test`).
...
2. Führt `./.github/actions/deploy-zyra-app` aus — das CI-Äquivalent zu `yarn zyra deploy`.
