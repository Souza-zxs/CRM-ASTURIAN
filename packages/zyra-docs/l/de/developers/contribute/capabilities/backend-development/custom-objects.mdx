...
Objekte sind Strukturen, die es Ihnen ermöglichen, Daten (Aufzeichnungen, Attribute und Werte) zu speichern, die spezifisch für eine Organisation sind. Zyra bietet sowohl Standard- als auch benutzerdefinierte Objekte.

Standardobjekte sind systemeigene Objekte mit einer Reihe von Attributen, die allen Benutzern zur Verfügung stehen. Beispiele für Standardobjekte in Zyra sind Unternehmen und Person. Standardobjekte verfügen über Standardfelder, die ebenfalls allen Zyra-Nutzern zur Verfügung stehen, wie z.B. Unternehmen.displayName.
