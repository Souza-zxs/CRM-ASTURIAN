...
info: Erfahren Sie, wie Sie im Figma von Zyra zusammenarbeiten können.
---
...
1. **Auf den freigegebenen Link zugreifen:** Sie können auf die Figma-Datei des Projekts [hier](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/Zyra) zugreifen.
...
In der linken Seitenleiste können Sie auf die verschiedenen Seiten der Figma-Datei von Zyra zugreifen. So sind sie organisiert:
