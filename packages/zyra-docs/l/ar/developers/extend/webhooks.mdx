...
يقوم Zyra بإرسال طلب HTTP POST إلى URL الخاص بك كلما تم إنشاء سجل أو تحديثه أو حذفه. جميع أنواع الكائنات مشمولة، بما في ذلك الكائنات المخصصة.
...
يرسل Zyra خطافات الويب لأنواع الأحداث التالية:
...
يقوم Zyra بتوقيع كل طلب خطاف ويب لأغراض الأمان. تحقّق من التواقيع للتأكد من أن الطلبات أصيلة.

### الرؤوس

| الترويسة                     | الوصف               |
| ---------------------------- | ------------------- |
| `X-Zyra-Webhook-Signature` | توقيع HMAC SHA256   |
| `X-Zyra-Webhook-Timestamp` | الطابع الزمني للطلب |

### خطوات التحقق

1. احصل على الطابع الزمني من `X-Zyra-Webhook-Timestamp`
2. أنشئ السلسلة: `{timestamp}:{JSON payload}`
3. احسب HMAC SHA256 باستخدام سر خطاف الويب الخاص بك
4. قارِن مع `X-Zyra-Webhook-Signature`
...
| **مشغّل خطاف ويب لسير العمل** | IN      | استقبال البيانات في Zyra من الأنظمة الخارجية              |
