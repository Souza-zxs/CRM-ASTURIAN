...
1. يجلب مصدر تطبيقك.
2. ينشئ مثيلاً اختبارياً معزولاً من Zyra باستخدام الإجراء المركّب `./.github/actions/spawn-zyra-app-dev-test` (المكافئ في CI للأمر `yarn zyra server start --test`).
...
2. يشغّل `./.github/actions/deploy-zyra-app` — وهو المكافئ في CI للأمر `yarn zyra deploy`.
