---
title: إنشاء عرض سعر أو فاتورة من Zyra
...
* [Generate a PDF from Zyra](/l/ar/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-zyra) — attach generated PDFs to records
