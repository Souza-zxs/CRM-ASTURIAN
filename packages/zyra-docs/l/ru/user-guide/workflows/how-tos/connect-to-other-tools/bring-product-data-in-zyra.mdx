---
title: Импортируйте данные о товарах в Zyra
description: Синхронизируйте данные каталога товаров из хранилища данных с вашей CRM по расписанию.
---

Используйте этот шаблон, чтобы поддерживать синхронизацию Zyra с данными о товарах из вашего хранилища данных (например, Snowflake, BigQuery, PostgreSQL).
...
5. **Upsert Record**: Создать или обновить в Zyra
