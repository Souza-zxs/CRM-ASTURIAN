...
description: Guía completa paso a paso para dar formato a tus datos para importarlos en Zyra.
---
...
**Este es el paso más importante.** El archivo de ejemplo te muestra los nombres de columna y el formato exactos que Zyra espera.
...
Zyra exige unicidad en determinados campos. Los duplicados provocarán errores de importación.
...
3. Comprueba si hay duplicados que ya existan en Zyra
...
* Debe ser único (sin duplicados en el archivo ni en Zyra)
...
* Debe ser único dentro de tu archivo y en Zyra
...
* **Enlaces / Etiqueta del enlace**: `Zyra`
* **Enlaces / URL del enlace**: `https://zyra.com`
...
* **Opcional**: Zyra genera IDs automáticamente si no se proporcionan
...
* El registro padre debe existir previamente en Zyra
...
## Paso 6: Asegúrate de que los campos existan en Zyra
