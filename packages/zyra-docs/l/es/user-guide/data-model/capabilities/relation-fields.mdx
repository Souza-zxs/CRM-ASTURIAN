...
Las relaciones de muchos a muchos usan un patrón de **objeto de unión**: un objeto intermedio que conecta ambos lados. Con la función de relaciones de unión, Zyra muestra directamente los registros finales vinculados, ocultando el objeto intermedio de la UI.
...
Zyra incluye relaciones predefinidas entre objetos estándar:
