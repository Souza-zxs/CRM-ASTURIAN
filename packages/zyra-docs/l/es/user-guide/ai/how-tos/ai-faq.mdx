...
description: Preguntas frecuentes sobre las funciones de IA en Zyra.
---
...
<AccordionGroup>
  ...
  <Accordion title="¿Qué capacidades de IA están previstas?">
    ...
    1. **Chatbot de IA**: Un asistente con conocimiento del contexto que puede acceder a tus datos de Zyra y ayudarte con consultas
  ...
  <Accordion title="¿Puedo usar mis propios modelos de IA?">
    Inicialmente, Zyra utilizará modelos de IA integrados. El soporte para modelos de IA personalizados o externos podría añadirse en versiones futuras según los comentarios de los usuarios.
  </Accordion>
