...
<AccordionGroup>
<Accordion title="¿Qué roles incluye Zyra por defecto?">
Zyra incluye los roles **Admin** y **Member** por defecto. Puedes crear roles personalizados adicionales según las necesidades de tu equipo (p. ej., Representante de ventas, Gerente, Usuario de solo lectura).
</Accordion>
...
Puedes controlar:
* **Send Email**: Capacidad para enviar correos desde Zyra
...
Con el aprovisionamiento JIT, las cuentas de usuario se crean automáticamente en Zyra cuando alguien inicia sesión mediante SSO por primera vez. Se les asigna automáticamente el rol predeterminado.
</Accordion>
