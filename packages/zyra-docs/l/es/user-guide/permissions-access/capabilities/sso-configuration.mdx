...
El inicio de sesión único (SSO) permite que los miembros de su equipo inicien sesión en Zyra utilizando el proveedor de identidad de su organización. Esto proporciona:
...
* Acceso de administrador al espacio de trabajo de Zyra

<Note>
**Para usuarios de autoalojamiento que deseen configurar SSO**, comuníquese con contact@zyra.com
</Note>
...
* Elimínelos del espacio de trabajo de Zyra
...
* **Asignación de grupos**: Asigne los grupos del IdP a roles de Zyra (si está disponible)
* **Proceso de desvinculación**: Incluya Zyra en su flujo de trabajo de desaprovisionamiento
