...
description: Siga una guía paso a paso sobre cómo registrarse en Zyra, elegir un plan de suscripción y configurar su cuenta.
---
...
1. Dirígete a [Zyra Sign Up](https://app.zyra.com).
...
Para consultas o ayuda, contacta con el equipo de soporte dedicado en [contact@zyra.com](mailto:contact@zyra.com) o envía un mensaje por [Discord](https://discord.gg/cx5n4Jzs57).
