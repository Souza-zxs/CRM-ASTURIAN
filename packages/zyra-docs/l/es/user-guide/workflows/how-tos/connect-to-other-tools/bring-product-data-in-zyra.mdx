---
title: Incorporar datos de productos en Zyra
description: Sincroniza los datos del catálogo de productos desde un almacén de datos a tu CRM según una programación.
---

Usa este patrón para mantener Zyra sincronizado con los datos de productos de tu almacén de datos (p. ej., Snowflake, BigQuery, PostgreSQL).
...
5. **Upsert Record**: Crear o actualizar en Zyra
