---
title: Generar una cotización o una factura desde Zyra
...
* [Generar un PDF desde Zyra](/l/es/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-zyra) — adjuntar los PDF generados a los registros
