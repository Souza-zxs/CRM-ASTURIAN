...
<Frame>
  <img src="/images/user-guide/what-is-zyra/20.png" alt="Encabezado" />
</Frame>
...
export const MyComponent = () => {
  ...
  return (
    <Select
      ...
      options={[
        { value: 'option1', label: 'Opción A', Icon: IconZyraStar },
        { value: 'option2', label: 'Opción B', Icon: IconZyraStar },
      ]}
      value="option1"
    />
  );
