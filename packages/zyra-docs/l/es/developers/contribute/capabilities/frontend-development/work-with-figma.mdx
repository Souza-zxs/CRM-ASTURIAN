...
info: Aprende cómo puedes colaborar con Zyra en Figma
---
...
1. **Accede al enlace compartido:** Puedes acceder al archivo de Figma del proyecto [aquí](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/Zyra).
...
En la barra lateral izquierda, puedes acceder a las diferentes páginas del Figma de Zyra. Así es como están organizadas:
