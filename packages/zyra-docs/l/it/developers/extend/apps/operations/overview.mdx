...
Il **livello operativo** è tutto ciò che fai *alla* tua app piuttosto che *con* essa: eseguire comandi CLI, eseguire test di integrazione contro un server Zyra reale, configurare la CI e distribuire le release — sia come tarball distribuito su un singolo server, sia come pacchetto npm elencato nel marketplace.
...
<CardGroup cols={2}>
  <Card title="CLI" icon="terminal" href="/l/it/developers/extend/apps/operations/cli">
    Riferimento a `yarn zyra` — exec, logs, uninstall, remotes.
  </Card>
