---
title: Concetti
description: Come funzionano le app Zyra — modello di entità, sandboxing e ciclo di vita dell’installazione.
icon: sitemap
---
...
| **Componente front-end**         | UI React in sandbox all’interno di Zyra              | [Componenti front-end](/l/it/developers/extend/apps/layout/front-components)              |
...
* **`yarn zyra dev:build`** — compila TypeScript, crea i bundle delle funzioni logiche e dei componenti front-end con esbuild e produce un manifest.
