...
2. Avvia un'istanza di test isolata di Zyra utilizzando l'azione composita `./.github/actions/spawn-zyra-app-dev-test` (l'equivalente per la CI di `yarn zyra server start --test`).
...
2. Esegue `./.github/actions/deploy-zyra-app` — l'equivalente per la CI di `yarn zyra deploy`.
