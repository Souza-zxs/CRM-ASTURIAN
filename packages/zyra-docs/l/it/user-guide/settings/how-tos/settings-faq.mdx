...
description: Domande frequenti sulle impostazioni di Zyra.
---
...
Per modificare il tuo indirizzo email, contatta [contact@zyra.com](mailto:contact@zyra.com).
</Accordion>
...
* **Sottodominio**: usa un sottodominio di Zyra come `yourcompany.zyra.com`
