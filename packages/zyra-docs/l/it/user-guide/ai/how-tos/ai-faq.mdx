---
title: FAQ sull'IA
description: Domande frequenti sulle funzionalità di IA in Zyra.
---
...
<AccordionGroup>
  ...
  <Accordion title="Quali capacità di IA sono previste?">
    ...
    1. **Chatbot IA**: un assistente contestuale che può accedere ai tuoi dati di Zyra e aiutarti con le tue domande
  ...
  <Accordion title="Posso usare i miei modelli di IA?">
    Inizialmente, Zyra utilizzerà modelli di IA integrati. Il supporto per modelli di IA personalizzati o esterni potrebbe essere aggiunto in versioni future in base al feedback degli utenti.
  </Accordion>
