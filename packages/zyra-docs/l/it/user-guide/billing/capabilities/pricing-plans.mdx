...
description: Scopri i piani tariffari di Zyra e come passare da uno all'altro.
---

## Panoramica

Zyra offre prezzi flessibili per team di ogni dimensione, sia con hosting cloud sia con self‑hosting.
...
Esegui Zyra sulla tua infrastruttura senza costi:
