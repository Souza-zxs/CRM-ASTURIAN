...
description: Segui una guida passo passo su come registrarti su Zyra, scegliere un piano di abbonamento e configurare il tuo account.
---
...
1. Vai a [Registrati su Zyra](https://app.zyra.com).
...
Per domande o aiuto, contatta il team di supporto dedicato a [contact@zyra.com](mailto:contact@zyra.com) o invia un messaggio su [Discord](https://discord.gg/cx5n4Jzs57).
