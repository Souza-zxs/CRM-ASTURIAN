...
description: Controlla quali email vengono importate in Zyra.
---

## Panoramica

Per impostazione predefinita, Zyra sincronizza tutte le email esterne dalla tua casella di posta collegata. Puoi limitare ciò che viene importato utilizzando la **selezione delle cartelle** e le **impostazioni di visibilità**.
