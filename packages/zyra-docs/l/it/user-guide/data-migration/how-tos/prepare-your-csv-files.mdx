...
description: Guida completa passo passo per formattare i tuoi dati per l'importazione in Zyra.
---
...
**Questo è il passaggio più importante.** Il file di esempio ti mostra i nomi delle colonne e il formato esatti che Zyra si aspetta.
...
Zyra impone l'unicità su alcuni campi. I duplicati causeranno errori di importazione.
...
3. Verifica la presenza di duplicati già esistenti in Zyra
...
* Deve essere univoco (nessun duplicato nel file o in Zyra)
...
* Deve essere univoco all'interno del tuo file e in Zyra
...
* **Link / Etichetta del link**: `Zyra`
* **Link / URL del link**: `https://zyra.com`
...
* **Opzionale**: Zyra genera automaticamente gli ID se non forniti
...
* Il record padre deve già esistere in Zyra
...
## Passaggio 6: Verifica che i campi esistano in Zyra
