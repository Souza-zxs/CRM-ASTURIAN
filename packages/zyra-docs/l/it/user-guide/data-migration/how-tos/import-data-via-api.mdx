...
description: Quando e come usare le API di Zyra per importazioni di dati su larga scala.
---

## Panoramica

Zyra offre sia **GraphQL** che **API REST** per l'importazione programmatica dei dati. Usa l'API quando l'importazione CSV non è pratica per il tuo volume di dati o quando hai bisogno di importazioni automatizzate e ricorrenti.
...
Zyra applica limiti di frequenza per garantire la stabilità del sistema:
...
* Verifica che i formati soddisfino i requisiti di Zyra (vedi [Mappatura dei campi](/l/it/user-guide/data-migration/capabilities/field-mapping))
...
* Verifica che i dati compaiano correttamente in Zyra
...
Contattaci a [contact@zyra.com](mailto:contact@zyra.com) oppure scopri i nostri [Servizi di implementazione](/l/it/user-guide/getting-started/capabilities/implementation-services).
