...
Il Single Sign-On (SSO) consente ai membri del tuo team di accedere a Zyra utilizzando il provider di identità della tua organizzazione. Questo offre:
...
* Accesso amministratore allo spazio di lavoro Zyra

<Note>
**Per gli utenti self-hosting che desiderano configurare l'SSO**, contatta contact@zyra.com
</Note>
...
* Rimuovili dallo spazio di lavoro Zyra
...
* **Mappatura dei gruppi**: Mappa i gruppi IdP ai ruoli di Zyra (se disponibile)
* **Processo di offboarding**: Includi Zyra nel tuo flusso di lavoro di deprovisioning
