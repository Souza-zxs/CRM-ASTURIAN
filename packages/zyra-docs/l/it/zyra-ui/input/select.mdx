...
<Frame>
  <img src="/images/user-guide/what-is-zyra/20.png" alt="Intestazione" />
</Frame>
...
export const MyComponent = () => {
  ...
  return (
    <Select
      ...
      options={[
        { value: 'option1', label: 'Opzione A', Icon: IconZyraStar },
        { value: 'option2', label: 'Opzione B', Icon: IconZyraStar },
      ]}
      value="option1"
    />
  );
