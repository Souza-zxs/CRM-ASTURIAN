...
| UI uzantılarına sahip Zyra Uygulaması             | [Uygulamalar](/l/tr/developers/extend/apps/getting-started) (OAuth otomatik olarak yönetilir) |

## Bir İstemci Kaydedin

Zyra, [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591) uyarınca **dinamik istemci kaydını** destekler. Manuel kurulum gerekmez — programatik olarak kaydedin:
...
Uygulamanız bir Zyra kullanıcısı adına hareket ettiğinde bu akışı kullanın.
...
Yetkilendirmeden sonra, Zyra `redirect_uri` adresinize geri yönlendirir:
...
Zyra, OAuth yapılandırmasını standart bir keşif uç noktasında yayımlar:
