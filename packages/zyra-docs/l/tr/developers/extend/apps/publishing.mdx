...
2. `./.github/actions/spawn-zyra-app-dev-test` bileşik eylemini kullanarak yalıtılmış bir Zyra test örneği başlatır (CI'daki `yarn zyra server start --test` eşdeğeri).
...
2. `./.github/actions/deploy-zyra-app` çalıştırır — `yarn zyra deploy` komutunun CI eşdeğeridir.
