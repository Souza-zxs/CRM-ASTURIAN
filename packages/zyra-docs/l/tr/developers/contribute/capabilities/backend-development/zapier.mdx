...
Zapier'i kullanarak Zyra'yi 3000+ uygulama ile zahmetsizce senkronize edin. Görevleri otomatikleştirin, verimliliği artırın ve müşteri ilişkilerinizi güçlendirin!
...
`packages/zyra-zapier` klasöründen şunu çalıştırın:
