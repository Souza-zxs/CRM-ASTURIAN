...
description: Verilerinizi herhangi bir CRM'den Zyra'ye taşımak için adım adım kılavuz.
---

## Genel Bakış

Bu kılavuz, verilerinizi herhangi bir CRM'den Zyra'ye taşıma sürecinde size yol gösterir. Süreç, verilerinizi denetlemeyi, Zyra çalışma alanınızı hazırlamayı, mevcut sisteminizden dışa aktarmayı ve Zyra'ye içe aktarmayı içerir.
...
Mevcut CRM'iniz ile Zyra arasında bir eşleme belgesi oluşturun:
...
## Adım 3: Zyra Çalışma Alanınızı Kurun

Verileri içe aktarmadan önce Zyra çalışma alanınızı hazırlayın:
...
Verileriniz kullanıcı referansları içeriyorsa (Hesap Sahibi, Atanan vb.), bu kullanıcıların içe aktarmadan önce Zyra'de mevcut olması gerekir. Aksi halde bu ilişkiler eşlenemez.
</Warning>
...
Dışa aktarılan her CSV'yi bir hesap tablosu uygulamasında açın ve Zyra için hazırlayın.
...
3. Zyra'de halihazırda yinelenen olmadığını doğrulayın
...
`https://domain.com` kullanın (`domain.com` veya `www.domain.com` değil). Bu, Zyra'nin biçimiyle eşleşir ve e-posta/takvim eşzamanlamasını bağladığınızda yinelenmeleri önler.
</Warning>
...
2. Kullanıcıların Zyra çalışma alanınıza katılmak için kullandıklarıyla aynı e-posta adreslerini kullanın
...
* Zyra, e-postaları kişi kayıtlarıyla eşzamanlamaya başlayacaktır
...
<AccordionGroup>
  <Accordion title="İş akışlarını otomatik olarak taşıyabilir miyim?">
    Şu anda mümkün değil. İş akışları Zyra'de manuel olarak yeniden oluşturulmalıdır.
  </Accordion>
...
[contact@zyra.com](mailto:contact@zyra.com) adresinden bizimle iletişime geçin veya [Uygulama Hizmetlerimizi](/l/tr/user-guide/getting-started/capabilities/implementation-services) keşfedin.
