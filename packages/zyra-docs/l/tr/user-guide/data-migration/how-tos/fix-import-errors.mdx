...
Dosyanızı yükledikten ve sütunları eşledikten sonra, Zyra verilerinizi doğrular:

1. **Doğrulama çalışır** — Zyra her satırı hatalar için kontrol eder
...
| ------------------------------------------------------------------------------ | -------------------------------------------------------------- |
| Yinelenen değerler sarı renkle vurgulanır                                      | Değer Zyra'de zaten mevcut veya dosyanızda iki kez görünüyor |
...
**Seçenek 3: Mevcut kaydı Zyra'nin güncellemesine izin verin**
...
3. Zyra, yinelenen bir kayıt oluşturmak yerine mevcut kaydı güncelleyecektir
...
Benzersiz tanımlayıcılardan biri eşleştiği sürece Zyra kaydı günceller.
</Note>
...
3. Kayıtların Zyra'de zaten mevcut olup olmadığını kontrol edin
...
Bu, Zyra'de o özel tanımlayıcıya sahip bir Şirket olmadığı anlamına gelir.
...
Zyra'de mevcut olmayan bir kayda bağlanmaya çalışıyorsunuz.
...
Dosyanızdaki bir sütun eşlenemiyor çünkü alan Zyra'de mevcut değil.
...
1. **Kullanıcı davetini kabul etmedi** — kullanıcı henüz Zyra'de mevcut değil
2. **Eski sistemdeki kullanıcı kimliğini kullanma** — Zyra başka bir sistemin kimliklerini eşleştiremez
3. **Yanlış e-posta biçimi** — e-posta, kullanıcının Zyra hesabıyla eşleşmiyor

### Nasıl Düzeltilir

1. Tüm kullanıcıların Zyra çalışma alanınıza **davetlerini kabul ettiğinden** emin olun
2. Kullanıcının **e-posta adresini** kullanın (adlarını veya eski sistem kimliğini değil)
3. Zyra'ye katılmak için kullandıkları aynı e-postayı kullanın
...
<Check>Alan adı biçimi, Zyra'nin biçimiyle birebir eşleşir</Check>
...
1. **Örnek dosyayı indirin** — Zyra'nin beklediği tam biçimi görün
