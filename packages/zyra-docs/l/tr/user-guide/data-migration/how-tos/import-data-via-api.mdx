...
description: Büyük ölçekli veri içe aktarmaları için Zyra'nin API'lerini ne zaman ve nasıl kullanacağınız.
---

## Genel Bakış

Zyra, programatik veri içe aktarma için hem **GraphQL** hem de **REST API'leri** sunar. Veri hacminiz için CSV içe aktarma pratik değilse veya otomatik, yinelenen içe aktarmalara ihtiyacınız varsa API'yi kullanın.
...
Zyra, sistem kararlılığını sağlamak için hız sınırlarını uygular:
...
* Biçimlerin Zyra'nin gereksinimlerine uyduğunu doğrulayın (bkz. [Alan Eşleme](/l/tr/user-guide/data-migration/capabilities/field-mapping))
...
* Verilerin Zyra'de doğru göründüğünü doğrulayın
