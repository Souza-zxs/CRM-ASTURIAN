---
title: Zyra'den Teklif veya Fatura Oluşturun
...
* [Zyra'den bir PDF oluşturun](/l/tr/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-zyra) — oluşturulan PDF'leri kayıtlara ekleyin
