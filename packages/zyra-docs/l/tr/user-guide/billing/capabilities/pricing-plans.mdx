...
description: Zyra'nin fiyatlandırma planlarını ve bunlar arasında nasıl geçiş yapacağınızı öğrenin.
---

## Genel Bakış

İster bulut barındırma ister kendi kendine barındırmayı tercih edin, Zyra her ölçekte ekibe uyacak esnek fiyatlandırma sunar.
...
Zyra'yi kendi altyapınızda hiçbir ücret ödemeden barındırın:
