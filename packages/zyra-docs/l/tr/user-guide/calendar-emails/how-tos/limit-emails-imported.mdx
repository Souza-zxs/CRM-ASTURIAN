...
description: Hangi e-postaların Zyra'ye içe aktarılacağını kontrol edin.
---

## Genel Bakış

Varsayılan olarak, Zyra bağlı posta kutunuzdan tüm harici e-postaları senkronize eder. **Klasör seçimi** ve **görünürlük ayarlarını** kullanarak içe aktarılanları sınırlayabilirsiniz.
