...
description: Zyra'deki yapay zeka özellikleri hakkında sıkça sorulan sorular.
---
...
<AccordionGroup>
  ...
  <Accordion title="Hangi yapay zeka yetenekleri planlanıyor?">
    ...
    1. **Yapay Zeka Sohbet Botu**: Zyra verilerinize erişebilen ve sorgularınızda size yardımcı olabilen bağlamın farkında olan bir asistan
  ...
  <Accordion title="Kendi yapay zeka modellerimi kullanabilir miyim?">
    Başlangıçta, Zyra yerleşik yapay zeka modellerini kullanacaktır. Kullanıcı geri bildirimlerine bağlı olarak özel veya harici yapay zeka modellerine destek gelecekteki sürümlerde eklenebilir.
  </Accordion>
