...
Tek Oturum Açma (SSO), ekip üyelerinizin kuruluşunuzun kimlik sağlayıcısını kullanarak Zyra'ye giriş yapmasına olanak tanır. Bu şunları sağlar:
...
Zyra, SSO'yu şu sağlayıcılarla destekler:
...
* Zyra çalışma alanına yönetici erişimi

<Note>
**SSO'yu kurmak isteyen öz barındırma kullanıcıları için**, contact@zyra.com ile iletişime geçin
</Note>
...
* Zyra çalışma alanından kaldırın
...
* **Grup eşleme**: IdP gruplarını Zyra rollerine eşleyin (varsa)
* **Ayrılış süreci**: Erişim kaldırma iş akışınıza Zyra'yi dahil edin
