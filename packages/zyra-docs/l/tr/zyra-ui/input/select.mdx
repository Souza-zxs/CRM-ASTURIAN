...
<Frame>
  <img src="/images/user-guide/what-is-zyra/20.png" alt="Başlık" />
</Frame>
...
export const MyComponent = () => {
  ...
  return (
    <Select
      ...
      options={[
        { value: 'option1', label: 'Seçenek A', Icon: IconZyraStar },
        { value: 'option2', label: 'Seçenek B', Icon: IconZyraStar },
      ]}
      value="option1"
    />
  );
