...
Single Sign-On (SSO) le permite membrilor echipei dvs. să se autentifice în Zyra folosind furnizorul de identitate al organizației dvs. Acest lucru oferă:
...
* Acces de administrator la spațiul de lucru Zyra

<Note>
**Pentru utilizatorii care se auto-găzduiesc și doresc să configureze SSO**, contactați contact@zyra.com
</Note>
...
* Eliminați-i din spațiul de lucru Zyra
...
* **Maparea grupurilor**: Mapați grupurile IdP la rolurile Zyra (dacă este disponibilă)
* **Proces de offboarding**: Includeți Zyra în fluxul dvs. de deprovisionare
