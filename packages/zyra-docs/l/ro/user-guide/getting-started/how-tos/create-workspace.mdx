...
description: Urmați un ghid pas cu pas despre cum să vă înregistrați pe Zyra, să alegeți un plan de abonament și să vă configurați contul.
---
...
1. Navigați la [Zyra Sign Up](https://app.zyra.com).
...
Pentru întrebări sau ajutor, contactați echipa de suport dedicată la [contact@zyra.com](mailto:contact@zyra.com) sau trimiteți un mesaj pe [Discord](https://discord.gg/cx5n4Jzs57).
