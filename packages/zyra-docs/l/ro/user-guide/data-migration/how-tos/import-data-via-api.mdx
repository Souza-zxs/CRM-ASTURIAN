...
description: Când și cum să utilizați API-urile Zyra pentru importuri de date la scară mare.
---

## Prezentare generală

Zyra oferă atât **GraphQL**, cât și **API-uri REST** pentru importul programatic de date. Utilizați API-ul când importul CSV nu este practic pentru volumul dvs. de date sau când aveți nevoie de importuri automate, recurente.
...
Zyra impune limitări de rată pentru a asigura stabilitatea sistemului:
...
Zyra acceptă două tipuri de API:
...
* Verificați că formatele corespund cerințelor Zyra (consultați [Maparea câmpurilor](/l/ro/user-guide/data-migration/capabilities/field-mapping))
...
* Verificați că datele apar corect în Zyra
...
Contactați-ne la [contact@zyra.com](mailto:contact@zyra.com) sau explorați [Serviciile noastre de implementare](/l/ro/user-guide/getting-started/capabilities/implementation-services).
