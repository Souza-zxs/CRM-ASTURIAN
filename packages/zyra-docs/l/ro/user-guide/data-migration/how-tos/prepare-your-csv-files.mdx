...
description: Ghid complet, pas cu pas, pentru a formata datele pentru import în Zyra.
---
...
**Acesta este cel mai important pas.** Fișierul de mostră vă arată exact denumirile de coloane și formatul pe care îl așteaptă Zyra.
...
Zyra impune unicitatea pentru anumite câmpuri. Valorile duplicate vor provoca erori la import.
...
3. Verificați duplicatele care există deja în Zyra
...
* Trebuie să fie unic (fără duplicate în fișier sau în Zyra)
...
* Trebuie să fie unic în fișierul dvs. și în Zyra
...
* **Linkuri / Etichetă link**: `Zyra`
* **Linkuri / URL link**: `https://zyra.com`
...
* **Opțional**: Zyra generează automat ID-uri dacă nu sunt furnizate
...
* Înregistrarea părinte trebuie să existe deja în Zyra
...
## Pasul 6: Asigurați-vă că câmpurile există în Zyra
