...
description: Ghid pas cu pas pentru migrarea datelor din orice CRM către Zyra.
---

## Prezentare generală

Acest ghid vă ghidează prin procesul de migrare a datelor din orice CRM către Zyra. Procesul implică auditarea datelor, pregătirea spațiului de lucru Zyra, exportul din sistemul curent și importul în Zyra.
...
Creați un document de mapare între CRM-ul curent și Zyra:
...
## Pasul 3: Configurați spațiul dvs. de lucru Zyra

Înainte de a importa date, pregătiți spațiul dvs. de lucru Zyra:
...
Dacă datele dvs. includ referințe la utilizatori (Proprietar cont, Atribuit etc.), acei utilizatori trebuie să existe în Zyra înainte de import. În caz contrar, acele relații nu pot fi mapate.
</Warning>
...
Deschideți fiecare CSV exportat într-o aplicație de calcul tabelar și pregătiți-l pentru Zyra.
...
3. Verificați că nu există deja duplicate în Zyra
...
Folosiți `https://domain.com` (nu `domain.com` sau `www.domain.com`). Acest lucru corespunde formatului Zyra și previne duplicatele când conectați sincronizarea e-mailului/calendarului.
</Warning>
...
2. Folosiți aceleași adrese de e-mail pe care utilizatorii le-au folosit pentru a se alătura spațiului dvs. de lucru Zyra
...
* Zyra va începe să sincronizeze e-mailurile cu înregistrările de contact
...
<AccordionGroup>
  <Accordion title="Pot migra fluxurile de lucru automat?">
    Momentan, nu. Fluxurile de lucru trebuie recreate manual în Zyra.
  </Accordion>
...
Contactați [contact@zyra.com](mailto:contact@zyra.com) sau explorați [Serviciile noastre de implementare](/l/ro/user-guide/getting-started/capabilities/implementation-services).
