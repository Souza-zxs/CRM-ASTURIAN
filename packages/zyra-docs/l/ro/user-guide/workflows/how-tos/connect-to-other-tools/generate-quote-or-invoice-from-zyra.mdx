---
title: Generați o ofertă sau o factură din Zyra
...
* [Generați un PDF din Zyra](/l/ro/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-zyra) — atașați PDF-uri generate la înregistrări
