---
title: Importați datele despre produse în Zyra
description: Sincronizați datele catalogului de produse dintr-un depozit de date în CRM-ul dvs., conform unui program.
---

Folosiți acest model pentru a menține Zyra sincronizat cu datele despre produse din depozitul dvs. de date (de ex., Snowflake, BigQuery, PostgreSQL).
...
5. **Upsert Record**: Creați sau actualizați în Zyra
