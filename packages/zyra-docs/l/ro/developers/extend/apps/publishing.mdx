...
2. Pornește o instanță de test Zyra izolată folosind acțiunea compozită `./.github/actions/spawn-zyra-app-dev-test` (echivalentul din CI al `yarn zyra server start --test`).
...
2. Rulează `./.github/actions/deploy-zyra-app` — echivalentul din CI al `yarn zyra deploy`.
