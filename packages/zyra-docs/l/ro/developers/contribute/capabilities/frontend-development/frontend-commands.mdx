...
```bash
npx nx run asturian-front:lint # utilizați --fix pentru a corecta erorile de lint
```
...
```bash
npx nx run asturian-front:test # rulați teste jest
npx nx run asturian-front:storybook:serve:dev # rulați storybook
npx nx run asturian-front:storybook:test # rulați testele # (are nevoie de yarn storybook:serve:dev pentru a rula)
npx nx run asturian-front:storybook:coverage # (are nevoie de yarn storybook:serve:dev pentru a rula)
```
