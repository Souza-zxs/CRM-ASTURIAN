...
2. Inicia uma instância de teste do Zyra isolada usando a ação composta `./.github/actions/spawn-zyra-app-dev-test` (o equivalente em CI de `yarn zyra server start --test`).
...
2. Executa `./.github/actions/deploy-zyra-app` — o equivalente em CI de `yarn zyra deploy`.
3. Executa `./.github/actions/install-zyra-app` para que a versão recém-implantada seja instalada no workspace de destino.
