...
description: Siga um guia passo a passo sobre como se registrar na Zyra, escolher um plano de assinatura e configurar sua conta.
---
...
1. Navegue até [Cadastro Zyra](https://app.zyra.com).
...
Para dúvidas ou ajuda, conecte-se com a equipe de suporte dedicada em [contact@zyra.com](mailto:contact@zyra.com) ou envie uma mensagem no [Discord](https://discord.gg/cx5n4Jzs57).
