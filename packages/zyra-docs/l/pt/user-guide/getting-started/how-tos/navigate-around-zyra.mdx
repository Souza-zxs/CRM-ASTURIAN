...
O menu de comandos oferece **acesso rápido a ações** no Zyra. Você pode acessá-lo de duas maneiras:
...
* Acessar registros excluídos (Zyra dá suporte a exclusões lógicas e permanentes)
