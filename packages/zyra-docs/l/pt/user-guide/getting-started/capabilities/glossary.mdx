---
title: Glossário
description: Familiarize-se com a terminologia essencial usada no Zyra.
---

## API

API (Interface de Programação de Aplicações) permite que você conecte o Zyra com outros sistemas de software e construa integrações personalizadas.
...
Oportunidades no Zyra CRM são potenciais negócios ou vendas com contas ou contatos.
...
Tarefas no Zyra CRM são atividades atribuídas relacionadas a contatos, contas ou oportunidades.
...
Webhooks são mensagens automáticas enviadas do Zyra a outras aplicações quando eventos específicos ocorrem, permitindo a sincronização de dados em tempo real.
...
Um `Espaço de Trabalho` normalmente representa uma empresa usando o Zyra. Ele contém todos os registros e dados que você e os membros da sua equipe adicionam ao Zyra.
...
Membros do Espaço de Trabalho são os usuários do Zyra da sua equipe que têm acesso ao seu espaço de trabalho. Eles podem ser designados como proprietários ou responsáveis por registros.
