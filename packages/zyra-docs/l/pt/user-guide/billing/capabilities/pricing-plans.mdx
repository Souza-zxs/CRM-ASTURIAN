...
description: Saiba mais sobre os planos de preços do Zyra e como alternar entre eles.
---

## Visão Geral

O Zyra oferece preços flexíveis para atender equipes de todos os tamanhos, quer você prefira hospedagem em nuvem ou auto-hospedagem.
...
Hospede o Zyra na sua própria infraestrutura sem custo:
