...
description: Perguntas frequentes sobre painéis na Zyra.
---

<AccordionGroup>
  <Accordion title="Posso criar painéis privados?">
    Não, os painéis atualmente são visíveis para todos que têm acesso ao seu espaço de trabalho da Zyra. Painéis privados ainda não estão disponíveis.
  </Accordion>
  ...
  <Accordion title="Posso compartilhar painéis com usuários externos?">
    Não, compartilhar painéis com usuários fora do seu espaço de trabalho da Zyra (usuários que não são da Zyra) não é suportado no momento.
  </Accordion>
