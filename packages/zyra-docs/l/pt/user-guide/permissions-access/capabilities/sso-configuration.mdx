...
O Single Sign-On (SSO) permite que os membros da sua equipe façam login no Zyra usando o provedor de identidade da sua organização. Isso oferece:
...
O Zyra oferece suporte a SSO com:
...
* Acesso de administrador ao workspace do Zyra

<Note>
**Para usuários de auto-hospedagem que desejam configurar SSO**, entre em contato pelo contact@zyra.com
</Note>
...
* Remova-os do workspace do Zyra
...
* **Mapeamento de grupos**: Mapeie os grupos do IdP para as funções do Zyra (se disponível)
* **Processo de desligamento**: Inclua o Zyra no seu fluxo de trabalho de desprovisionamento
