...
description: Guia completo passo a passo para formatar seus dados para importação no Zyra.
---
...
**Esta é a etapa mais importante.** O arquivo de exemplo mostra os nomes exatos das colunas e o formato que o Zyra espera.
...
O Zyra impõe unicidade em determinados campos. Duplicados causarão erros de importação.
...
3. Verifique se há duplicados que já existem no Zyra
...
* Deve ser exclusivo (sem duplicados no arquivo ou no Zyra)
...
* Deve ser exclusivo dentro do seu arquivo e no Zyra
...
* **Links / Rótulo do Link**: `Zyra`
* **Links / URL do Link**: `https://zyra.com`
...
* **Opcional**: a Zyra gera IDs automaticamente se não forem fornecidos
...
* O registro pai já deve existir na Zyra
...
## Etapa 6: Garanta que os campos existam na Zyra
