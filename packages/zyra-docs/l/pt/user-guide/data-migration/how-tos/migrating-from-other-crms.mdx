...
description: Guia passo a passo para migrar os seus dados de qualquer CRM para o Zyra.
---

## Visão Geral

Este guia explica como migrar os seus dados de qualquer CRM para o Zyra. O processo envolve auditar os seus dados, preparar o seu espaço de trabalho no Zyra, exportar do seu sistema atual e importar para o Zyra.
...
Crie um documento de mapeamento entre o seu CRM atual e o Zyra:
...
## Passo 3: Configure o seu espaço de trabalho no Zyra

Antes de importar dados, prepare o seu espaço de trabalho no Zyra:
...
Se os seus dados incluírem referências a utilizadores (Proprietário da conta, Responsável, etc.), esses utilizadores devem existir no Zyra antes da importação. Caso contrário, essas relações não podem ser mapeadas.
</Warning>
...
Abra cada CSV exportado numa aplicação de folha de cálculo e prepare-o para o Zyra.

### Remova duplicados

1. Ordene pelo campo único (e-mail para Pessoas, domínio para Empresas)
2. Remova ou una linhas duplicadas
3. Verifique se não existem já duplicados no Zyra
...
Use `https://domain.com` (não `domain.com` nem `www.domain.com`). Isto corresponde ao formato do Zyra e evita duplicados quando ligar a sincronização de e-mail/calendário.
</Warning>
...
2. Use os mesmos endereços de e-mail que os utilizadores usaram para aderir ao seu espaço de trabalho no Zyra
...
1. Navegue até ao objeto no Zyra
...
* O Zyra começará a sincronizar e-mails com os registos de contactos
...
<AccordionGroup>
  <Accordion title="Posso migrar fluxos de trabalho automaticamente?">
    De momento, não. Os fluxos de trabalho devem ser recriados manualmente no Zyra.
  </Accordion>
...
Contacte [contact@zyra.com](mailto:contact@zyra.com) ou explore os nossos [Serviços de Implementação](/l/pt/user-guide/getting-started/capabilities/implementation-services).
