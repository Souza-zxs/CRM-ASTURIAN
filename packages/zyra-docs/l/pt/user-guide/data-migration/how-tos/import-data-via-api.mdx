...
description: Quando e como usar as APIs da Zyra para importações de dados em larga escala.
---

## Visão Geral

A Zyra oferece tanto **GraphQL** como **APIs REST** para a importação programática de dados. Use a API quando a importação por CSV não for prática para o seu volume de dados ou quando precisar de importações automatizadas e recorrentes.
...
A Zyra impõe limites de taxa para assegurar a estabilidade do sistema:
...
A Zyra suporta dois tipos de API:
...
* Verifique se os formatos correspondem aos requisitos da Zyra (veja [Mapeamento de Campos](/l/pt/user-guide/data-migration/capabilities/field-mapping))
...
* Verifique se os dados aparecem corretamente na Zyra
...
Contacte-nos em [contact@zyra.com](mailto:contact@zyra.com) ou explore os nossos [Serviços de Implementação](/l/pt/user-guide/getting-started/capabilities/implementation-services).
