---
title: Posso enviar e-mails a partir do Zyra?
description: Informações sobre o envio de e-mails diretamente a partir do Zyra.
---

## Estado atual

A integração de e-mail do Zyra foi concebida para **sincronizar e apresentar** o seu histórico de e-mails. Não é possível redigir ou enviar e-mails diretamente a partir da interface do Zyra.
...
Embora não seja possível enviar e-mails manualmente a partir do Zyra, **pode enviar e-mails automaticamente utilizando Fluxos de Trabalho**. Isto é útil para:
...
Para sequências de e-mails e boletins informativos, recomendamos utilizar Fluxos de Trabalho para ligar o Zyra a uma ferramenta dedicada de marketing por e-mail.
...
A redação nativa de e-mails dentro do Zyra está no nosso roteiro. Junte-se às nossas [discussões no GitHub](https://github.com/zyrahq/zyra/discussions) para partilhar o seu caso de uso e ajudar a priorizar esta funcionalidade.
