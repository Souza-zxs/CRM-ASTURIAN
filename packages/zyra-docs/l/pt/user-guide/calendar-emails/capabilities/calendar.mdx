---
title: Calendário
description: Entendendo os recursos de integração do calendário no Zyra.
---
...
O Zyra sincroniza automaticamente os eventos do seu calendário e os vincula aos registros relevantes do CRM, oferecendo uma visão completa do seu histórico de reuniões com contatos e empresas.
