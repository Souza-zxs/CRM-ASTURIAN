...
description: Aprenda a criar automações no Zyra.
---

## Por que Workflows Importam

Zyra foi criado para trazer flexibilidade máxima aos seus usuários. Em vez de forçá-lo a adaptar seus processos de negócios a recursos rígidos e pré-construídos, os workflows permitem que você crie automações que criem o CRM que melhor apoie seus casos de uso de negócios exclusivos.

Workflows são o recurso interno de Zyra para criar essas automações. Eles oferecem os blocos de construção para criar exatamente o que seu negócio precisa, quando precisa.
...
2. **Traga dados para dentro e para fora do Zyra**: Conecte-se ao Zyra por meio de chamadas de API e webhooks para seu banco de dados e outras ferramentas.
...
* **Formulário**: Obter entradas de usuários na interface do Zyra no momento da execução
