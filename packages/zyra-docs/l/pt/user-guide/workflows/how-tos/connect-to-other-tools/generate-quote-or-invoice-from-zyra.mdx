---
title: Gerar um orçamento ou fatura no Zyra
...
* [Gerar um PDF a partir do Zyra](/l/pt/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-zyra) — anexar PDFs gerados aos registros
