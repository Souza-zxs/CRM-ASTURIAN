---
title: IA
description: Funcionalidades com IA chegando em breve ao Zyra.
---
...
A Zyra está desenvolvendo capacidades de IA para ajudar sua equipe a trabalhar de forma mais inteligente. Estamos nos concentrando em duas áreas principais:

### 1. Chatbot de IA

Um assistente conversacional que entende seu contexto e tem acesso a todos os seus dados do Zyra.

**Principais capacidades:**

* **Acesso completo aos dados**: Consulte qualquer registro, relacionamento ou métrica no seu espaço de trabalho
* **Consciência do contexto da página**: Faça referência a "esta empresa" ou "esta oportunidade" com base em onde você está no Zyra
...
* Siga nosso [GitHub](https://github.com/zyrahq/zyra) para atualizações de desenvolvimento
