...
| **Intégrations personnalisées** | Votre application → automatisation dans Zyra                 |
...
3. Vous recevrez une URL de webhook unique, par exemple :
   ```
   https://api.zyra.com/webhooks/workflow/abc123...
   ```
...
```bash
curl -X POST https://api.zyra.com/webhooks/workflow/abc123... \
