---
title: Générer un devis ou une facture depuis Zyra
...
* [Générer un PDF à partir de Zyra](/l/fr/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-zyra) — joindre les PDF générés aux enregistrements
