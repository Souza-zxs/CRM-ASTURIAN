...
L'authentification unique (SSO) permet aux membres de votre équipe de se connecter à Zyra en utilisant le fournisseur d'identité de votre organisation. Cela offre :
...
Zyra prend en charge le SSO avec :
...
* Accès administrateur à l'espace de travail Zyra

<Note>
**Pour les utilisateurs en auto-hébergement souhaitant configurer le SSO**, contactez contact@zyra.com
</Note>
...
* Retirez-les de l'espace de travail Zyra
...
* **Correspondance de groupes** : Faites correspondre les groupes IdP aux rôles Zyra (si disponible)
* **Processus de départ** : Incluez Zyra dans votre workflow de déprovisionnement
