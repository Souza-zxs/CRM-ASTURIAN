...
Le menu de commandes vous donne **un accès rapide aux actions** dans Zyra. Vous pouvez y accéder de deux manières :
...
* Accéder aux enregistrements supprimés (Zyra prend en charge les suppressions logiques et définitives)
