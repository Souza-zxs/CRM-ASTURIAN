...
description: Quand et comment utiliser les API de Zyra pour des importations de données à grande échelle.
---

## Vue d'ensemble

Zyra propose des **API GraphQL** et **REST** pour l'importation programmatique de données. Utilisez l'API lorsque l'importation CSV n'est pas pratique pour votre volume de données ou lorsque vous avez besoin d'importations automatisées et récurrentes.
...
Zyra applique des limites de débit pour garantir la stabilité du système :
...
Zyra prend en charge deux types d'API :
...
* Vérifiez que les formats correspondent aux exigences de Zyra (voir [Correspondance des champs](/l/fr/user-guide/data-migration/capabilities/field-mapping))
...
* Vérifiez que les données s'affichent correctement dans Zyra
...
Contactez-nous à [contact@zyra.com](mailto:contact@zyra.com) ou découvrez nos [services de mise en œuvre](/l/fr/user-guide/getting-started/capabilities/implementation-services).
