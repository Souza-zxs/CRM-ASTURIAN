...
Zyra prend en charge l'importation de relations entre objets lors de l'importation CSV. Cela vous permet de lier des enregistrements (p. ex., associer des Personnes à des Entreprises) dans le cadre de votre migration de données.
...
## Fonctionnement des relations dans Zyra

### Un à plusieurs / Plusieurs à un

Zyra prend en charge des relations standard où un enregistrement est lié à plusieurs autres :
...
Avant d'importer le côté "plusieurs", les enregistrements du côté "un" doivent déjà exister dans Zyra.
...
4. Zyra liera automatiquement chaque enregistrement au parent correspondant
...
<Note>**Liaison vers les membres de l'espace de travail** : Lorsque la relation pointe vers des membres de l'espace de travail (votre équipe se connectant à Zyra), référencez-les par leur **adresse e-mail**, et non par leur nom.</Note>
