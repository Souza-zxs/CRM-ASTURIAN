...
description: Formats de fichiers pris en charge pour l’importation de données dans Zyra.
---

## Formats pris en charge

Zyra prend en charge trois formats de fichiers pour l’importation :
