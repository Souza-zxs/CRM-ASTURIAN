...
description: Foire aux questions sur les paramètres de Zyra.
---
...
Pour changer votre adresse e-mail, veuillez contacter [contact@zyra.com](mailto:contact@zyra.com).
</Accordion>
...
* **Sous-domaine** : Utilisez un sous-domaine Zyra comme `yourcompany.zyra.com`
