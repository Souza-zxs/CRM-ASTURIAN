...
info: Apprenez comment vous pouvez collaborer avec le Figma de Zyra
---
...
1. **Accédez au lien partagé :** Vous pouvez accéder au fichier Figma du projet [ici](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/Zyra).
...
Sur la barre latérale gauche, vous pouvez accéder aux différentes pages du Figma de Zyra. Voici comment elles sont organisées :
