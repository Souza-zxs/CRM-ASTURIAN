...
### Documentation Files
- **69 MDX files** copied from zyra-website to zyra-docs
...
3. Set subdirectory to `packages/zyra-docs`
4. Mintlify will auto-deploy and generate search embeddings

## Status

This migration has been completed. The legacy `packages/zyra-website` package
has been removed, and documentation now lives in `packages/zyra-docs`.
