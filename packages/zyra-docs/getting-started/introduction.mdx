...
You've been choosing between software that's easy to start but impossible to change, and software that's flexible but takes months to set up. Zyra is the third option: **a production-ready CRM you can reshape as you go.**


## What makes Zyra different

Zyra is a platform you can build on, not a product you configure.
...
<CardGroup cols={2}>
  ...
  <Card img="/images/user-guide/halftone/dev-api.png">
    ...
    React, TypeScript. Your team already knows how to extend Zyra. No proprietary languages, no gatekeeping.
  </Card>
  <Card img="/images/user-guide/halftone/dev-apps.png">
    <CardTitle>No Lock-In</CardTitle>
    Standard stack, open APIs, export your data anytime.
  </Card>
</CardGroup>
...
- **GTM teams looking for an edge** — you want to build
  ...
  outbound workflows.
- **Privacy-conscious organizations** — you need full
  control over your data, with clear export and residency
  options. Regulatory, contractual, or just principle.
- **Salesforce partners**  —
...
and PostgreSQL. Zyra opens the CRM market
...
- **Teams that want a CRM they never have to think
  about.** Zyra rewards teams that want to stay close to
...
<Card title="Ready to get started?" icon="rocket" href="/getting-started/quickstart">
  Set up Zyra in under 5 minutes.
</Card>
