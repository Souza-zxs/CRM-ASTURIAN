---
title: Key Features
description: A tour of everything Zyra can do — from custom data models to AI-powered automation.
icon: "star"
---

import { CardTitle } from "/snippets/card-title.mdx"

Zyra is a full-featured CRM platform. Here's what you can build with it.
