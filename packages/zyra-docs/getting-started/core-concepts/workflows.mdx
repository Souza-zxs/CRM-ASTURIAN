---
title: Workflows
description: Automate your business processes with Zyra's visual workflow builder.
icon: "bolt"
---

import { VimeoEmbed } from '/snippets/vimeo-embed.mdx';

Workflows let you automate repetitive tasks and connect Zyra to external tools — without writing code (though you can if you want to).
...
- Sync data between Zyra and your billing system
