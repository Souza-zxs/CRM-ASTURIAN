...
Deploy Zyra CRM on Kubernetes with server, worker, PostgreSQL, and Redis components.
...
helm install my-zyra ./packages/zyra-docker/helm/zyra \
  --namespace zyracrm --create-namespace
```
...
- Database `zyra` and schema `core` are created automatically by server init container
...
```bash
helm lint ./packages/zyra-docker/helm/zyra
helm template my-zyra ./packages/zyra-docker/helm/zyra
helm plugin install https://github.com/quintush/helm-unittest
helm unittest ./packages/zyra-docker/helm/zyra
```
...
helm install my-zyra ./packages/zyra-docker/helm/zyra -f values-secrets.yaml
```
